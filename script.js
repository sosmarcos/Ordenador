...
var rischioto = new Inventario(
    ...
    [
        ...
        new item(1, 'Balde Reforçado - 12 litros', 'balde_reforçado'),
        ...
        new item(2, 'Caixa Organizadora - 20 litros', 'conteiner'),
        new item(9, 'Caixa Organizadora - 50 litros', 'conteiner'),
        new item(2, 'Caixa Organizadora - 80 litros', 'conteiner'),

        new item(7, 'Caixa Rattan Areia - 2.5 litros', 'caixa_rattan'),
        new item(7, 'Caixa Rattan Areia - 4 litros', 'caixa_rattan'),
        new item(3, 'Caixa Rattan Areia - 7.5 litros', 'caixa_rattan'),
        new item(1, 'Caixa Rattan Areia - 15 litros', 'caixa_rattan'),
        ...
        new item(7, 'Jardineira Floratta n50 Areia', 'jardineira_floratta_50'),
        ...
        new item(12, 'Jardineira n35 Cerâmica', 'jardineira_n35'),
        new item(25, 'Jardineira n35 Preta', 'jardineira_n35'),

        new item(30, 'Jardineira n50 Areia', 'jardineira_n50'),
        new item(11, 'Jardineira n50 Cerâmica', 'jardineira_n50'),
        new item(7, 'Jardineira n50 Preta', 'jardineira_n50'),
        ...
        new item(30, 'Vaso Parede Floratta 3 litros Areia', 'vp_floratta_3'),
        new item(25, 'Vaso Parede Floratta 3 litros Azul', 'vp_floratta_3'),
        new item(21, 'Vaso Parede Floratta 3 litros Rosa', 'vp_floratta_3'),
        new item(19, 'Vaso Parede Floratta 3 litros Verde', 'vp_floratta_3'),

        new item(9, 'Vaso Parede Floratta 6 litros Areia', 'vp_floratta_6'),
        new item(18, 'Vaso Parede Floratta 6 litros Azul', 'vp_floratta_6'),
        new item(18, 'Vaso Parede Floratta 6 litros Rosa', 'vp_floratta_6'),
        ...
        new item(14, 'Vaso Parede Florença 3.3 litros Cerâmica', 'vp_florença_3.3'),
        new item(21, 'Vaso Parede Florença 3.3 litros Preto', 'vp_florença_3.3'),

        new item(13, 'Vaso Redondo Floratta n15 Areia', 'redondo_floratta_15'),
        new item(8, 'Vaso Redondo Floratta n15 Azul', 'redondo_floratta_15'),
        new item(8, 'Vaso Redondo Floratta n15 Rosa', 'redondo_floratta_15'),
        new item(8, 'Vaso Redondo Floratta n15 Verde', 'redondo_floratta_15'),

        new item(5, 'Vaso Redondo Floratta n19 Areia', 'redondo_floratta_19'),
        ...
        new item(30, 'Vaso Redondo Floratta n40 Areia', 'redondo_floratta_40'),
        ...
        new item(48, 'Vaso Redondo n13 Areia', 'redondo_n13'),
        new item(37, 'Vaso Redondo n13 Cerâmica', 'redondo_n13'),
        new item(7, 'Vaso Redondo n13 Preta', 'redondo_n13'),

        new item(47, 'Vaso Redondo n17 Areia', 'redondo_n17'),
        new item(46, 'Vaso Redondo n17 Cerâmica', 'redondo_n17'),
        ...
        new item(1, 'Vaso Redondo n42 Preta', 'redondo_n42'),

        new item(0, 'Vaso Redondo n50 Areia', 'redondo_n50'),
        new item(0, 'Vaso Redondo n50 Cerâmica', 'redondo_n50'),
        new item(0, 'Vaso Redondo n50 Preta', 'redondo_n50'),

        new item(37, 'Vaso Quadrado n17 Areia', 'quadrado_n17'),
        new item(30, 'Vaso Quadrado n17 Cerâmica', 'quadrado_n17'),
        ...
        new item(20, 'Vaso Quadrado n22 Preta', 'quadrado_n22'),
        ...
        new item(0, 'Vaso Quadrado n35 Preta', 'quadrado_n35'),

        new item(0, 'Vaso Quadrado n42 Areia', 'quadrado_n42'),
        new item(0, 'Vaso Quadrado n42 Cerâmica', 'quadrado_n42'),
        new item(0, 'Vaso Quadrado n42 Preta', 'quadrado_n42')
    ]
)
...
var forth = new Inventario(
    ...
    [
        ...
        new item(8, 'Cote 15.09.12 - 400g', 'c'),
        new item(0, 'Cupinicida Concentrado - 60ml', 'c'),

        new item(0, 'Defende Concentrado - 30ml', 'd'),
        new item(2, 'Defende p/uso - 500ml', 'd'),

        new item(1, 'Enraizador Concentrado - 60ml', 'e'),
        ...
        new item(3, 'Jardim - 400g', 'j'),
        new item(9, 'Jardim - 3kg', 'j'),
        ...
        new item(10, 'Orquídeas 30.10.10 - 100g', 'o'),
        new item(3, 'Orquídeas 09.45.15 - 400g', 'o'),
        new item(5, 'Orquídeas 20.20.20 - 400g', 'o'),
        new item(3, 'Orquídeas 30.10.10 - 400g', 'o'),
...
var alfa = new Inventario(
    ...
    [
        ...
        new item(5, 'Coluna Red. Grafiato C/Prato nº 3 Marrom', 'coluna_grafiato_3'),
...
var coquim = new Inventario(
    ...
    [
        ...
        new item(11, '1001 - Vaso Coquim nº 5', 'vaso_coquim'),
        new item(5, '1002 - Vaso Coquim nº 8', 'vaso_coquim'),
        new item(5, '1003 - Vaso Coquim nº 10', 'vaso_coquim'),
        new item(10, '1004 - Vaso Coquim nº 12', 'vaso_coquim'),
        new item(2, '1005 - Vaso Coquim nº 14', 'vaso_coquim'),
        ...
        new item(8, '1010 - Vaso Coquim nº 13', 'vaso_coquim'),
        new item(2, '1012 - Vaso Coquim nº 15', 'vaso_coquim'),

        new item(1, '2001 - Placa Coquim 20x20', 'placa_coquim'),
        ...
        new item(0, '2008 - Placa Redonda Coquim 25cm', 'placa_redonda'),
        new item(0, '2009 - Placa Redonda Coquim 30cm', 'placa_redonda'),
        new item(0, '2010 - Placa Redonda Coquim 35cm', 'placa_redonda'),
        new item(0, '2011 - Placa Redonda Coquim 40cm', 'placa_redonda'),
        new item(0, '2012 - Placa Redonda Coquim 50cm', 'placa_redonda'),

        new item(0, '2013 - Placa Colmeia Coquim 30cm', 'placa_colmeia'),

        new item(20, '2999 - Estaca Coquim 30cm', 'estaca_coquim'),
        new item(23, '3000 - Estaca Coquim 40cm', 'estaca_coquim'),
        ...
        new item(0, '5001 - Placa 20x40cm Com 1 Meio Vaso nº 10', 'placa_com_vaso'),
        new item(1, '5002 - Placa 40x40cm Com 1 Meio Vaso nº 12', 'placa_com_vaso'),
        new item(2, '5003 - Placa 20x60cm Com 2 Meio Vasos nº 8', 'placa_com_vaso'),
        new item(1, '5007 - Placa 30x40cm Com 1 Meio Vaso nº 12', 'placa_com_vaso'),
        new item(0, '5008 - Placa 20x30cm Com 1 Meio Vaso nº 10', 'placa_com_vaso'),
        new item(0, '5013 - Placa 40x80cm Com 2 Meio Vasos nº 14', 'placa_com_vaso'),
        new item(0, '5014 - Painel 1.00x1.00m Com 8 Meio Vasos nº 12', 'placa_com_vaso'),
        new item(1, '5015 - Placa 30x40cm Com 2 Meio Vasos nº 10', 'placa_com_vaso'),
        ...
        new item(0, '5021 - 1/2 Vaso nº 15 Com Placa Redonda 30cm', 'meio_vaso'),
        new item(0, '5022 - 1/2 Vaso nº 17 Com Placa Redonda 35cm', 'meio_vaso'),
        ...
        new item(0, '5027 - 1/2 Vaso nº 10 Com Placa Colmeia 30cm', 'meio_vaso'),
        new item(0, '5028 - 1/2 Vaso Virola nº 10 Com Placa Colmeia 30cm', 'meio_vaso'),
        new item(0, '5026 - 1/2 Vaso nº 13 Com Placa Colmeia 30cm', 'meio_vaso'),

        new item(4, '8005 - Vaso Coquim 05 Com Suporte', 'vaso_cordeinha'),
        new item(7, '8006 - Vaso Coquim 08 Com Suporte', 'vaso_cordeinha'),
        new item(6, '8007 - Vaso Coquim 10 Com Suporte', 'vaso_cordeinha'),
        ...
        new item(3, '9022 - Kokindama', 'coquidama'),
        new item(17, '9023 - Cestindama', 'coquidama'),
        new item(12, '9024 - Kokindama P', 'coquidama'),
        new item(14, '9025 - Cestindama P', 'coquidama'),

        new item(13, '9028 - Coquim Orquidea de Parede Mini', 'cone'),
        new item(11, '9029 - Coquim Orquidea de Parede P', 'cone'),
        new item(7, '8000 - Coquim Orquidea de Parede M', 'cone'),
        new item(2, '9030 - Coquim Orquidea de Parede G', 'cone'),
        new item(4, '9031 - Coquim Orquidea de Parede GG', 'cone'),

        new item(6, '9040 - Cesto Aramado Coquim 25cm com Manta e Corrente', 'cesto_aramado'),
        new item(12, '9041 - Cesto Aramado Coquim 30cm com Manta e Corrente', 'cesto_aramado'),
        new item(5, '9042 - Cesto Aramado Coquim 35cm com Manta e Corrente', 'cesto_aramado'),
    ]
)
