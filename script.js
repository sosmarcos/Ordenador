...
var diversos = new Inventario(
    ...
    [
        ...
        new item(5, 'Cachepo Tripe Azul Escuro', 'cachepo_tripe'),
        new item(17, 'Cachepo Tripe Branco', 'cachepo_tripe'),
        new item(2, 'Cachepo Tripe Cinza', 'cachepo_tripe'),
        new item(6, 'Cachepo Tripe Preto', 'cachepo_tripe'),
        new item(1, 'Cachepo Tripe Rosa', 'cachepo_tripe'),
        ...
        new item(14, 'Roundup 1 litro', 'roundup'),
        ...
        new item(13, 'Tordon 100ml', 'tordon'),
...
var regaplan = new Inventario(
    ...
    '02/04/2024',
    [
        new item(83, 'Corrente 44cm - Dourado 1.6mm', 'corrente_1.6mm'),
        ...
        new item(35, 'Gancho S Grande - Dourado 18cm', 'gancho_S'),
        new item(30, 'Gancho S Médio - Dourado 10cm', 'gancho_S'),
        new item(25, 'Gancho S Pequeno - Dourado 7cm', 'gancho_S'),

        new item(90, 'Suporte A Reforçado 01 - 19cm Dourado', 'sp_a_reforçado'),
        new item(90, 'Suporte A Reforçado 02 - 24cm Dourado', 'sp_a_reforçado'),
        new item(80, 'Suporte A Reforçado 03 - 29cm Dourado', 'sp_a_reforçado'),
        new item(89, 'Suporte A Reforçado 04 - 34cm Dourado', 'sp_a_reforçado'),
        ...
        new item(9, 'Suporte Coador 30cm Preto', 'sp_coador'),
        ...
        new item(28, 'Suporte Rasteiro Chapa 04 - 27cm Dourado', 'sp_rasteiro'),
        ...
        new item(6, 'Tripé Decorativo Grande Dourado', 'tp_decorativo'),
        new item(6, 'Tripé Decorativo Grande Preto', 'tp_decorativo'),
        new item(3, 'Tripé Decorativo Médio Dourado', 'tp_decorativo'),
        new item(6, 'Tripé Decorativo Médio Preto', 'tp_decorativo'),
        new item(5, 'Tripé Decorativo Pequeno Dourado', 'tp_decorativo'),
        new item(13, 'Tripé Decorativo Pequeno Preto', 'tp_decorativo'),

        new item(8, 'Tripé Suspenso 01 20x40cm', 'tp_suspenso'),
        new item(10, 'Tripé Suspenso 02 25x40cm', 'tp_suspenso'),
...
var rischioto = new Inventario(
    ...
    [
        ...
        new item(4, 'Caixa Rattan Tabaco - 15 litros', 'caixa_rattan'),
        ...
        new item(15, 'Copo Medidor', 'copo_medidor'),

        new item(31, 'Cuia Bella Fiore 4 litros Areia', 'cuia_bf_4'),
        new item(18, 'Cuia Bella Fiore 4 litros Cerâmica', 'cuia_bf_4'),
        new item(18, 'Cuia Bella Fiore 4 litros Preto', 'cuia_bf_4'),
        new item(18, 'Cuia Bella Fiore 4 litros Verde', 'cuia_bf_4'),

        new item(31, 'Cuia Bella Fiore 7.5 litros Areia', 'cuia_bf_7.5'),
        new item(25, 'Cuia Bella Fiore 7.5 litros Cerâmica', 'cuia_bf_7.5'),
        new item(35, 'Cuia Bella Fiore 7.5 litros Preto', 'cuia_bf_7.5'),
        new item(18, 'Cuia Bella Fiore 7.5 litros Verde', 'cuia_bf_7.5'),

        new item(8, 'Escorredor de Pratos Supreme', 'escorredor'),
        new item(18, 'Escorredor de Talheres', 'escorredor'),
        new item(8, 'Escorredor Lava Tudo', 'escorredor'),
        new item(20, 'Escorredor Multiuso', 'escorredor'),

        new item(40, 'Forma de Gelo 2 Peças', 'forma_gelo'),

        new item(16, 'Floreira Floratta n30 Areia', 'floreira_30'),
        new item(44, 'Floreira Floratta n30 Azul', 'floreira_30'),
        new item(28, 'Floreira Floratta n30 cinza', 'floreira_30'),
        new item(19, 'Floreira Floratta n30 Preta', 'floreira_30'),
        new item(28, 'Floreira Floratta n30 Rosa', 'floreira_30'),
        new item(28, 'Floreira Floratta n30 Verde', 'floreira_30'),
        new item(15, 'Floreira Floratta n30 Verde Escuro', 'floreira_30'),

        new item(16, 'Jarra Quadrada - 2 litros', 'jarra'),
        ...
        new item(29, 'Jardineira Bella Fiore n35 Preta', 'jardineira_n35'),
        new item(18, 'Jardineira Bella Fiore n35 Verde', 'jardineira_n35'),

        new item(28, 'Jardineira Bella Fiore n50 Areia', 'jardineira_n50'),
        new item(34, 'Jardineira Bella Fiore n50 Cerâmica', 'jardineira_n50'),
        new item(34, 'Jardineira Bella Fiore n50 Preta', 'jardineira_n50'),
        new item(16, 'Jardineira Bella Fiore n50 Verde', 'jardineira_n50'),

        new item(18, 'Jardineira Floratta n50 Areia', 'jardineira_floratta_50'),
        new item(31, 'Jardineira Floratta n50 Azul', 'jardineira_floratta_50'),
        new item(3, 'Jardineira Floratta n50 cinza', 'jardineira_floratta_50'),
        new item(19, 'Jardineira Floratta n50 Preta', 'jardineira_floratta_50'),
        new item(28, 'Jardineira Floratta n50 Rosa', 'jardineira_floratta_50'),
        new item(35, 'Jardineira Floratta n50 Verde', 'jardineira_floratta_50'),
        new item(20, 'Jardineira Floratta n50 Verde Escuro', 'jardineira_floratta_50'),

        new item(15, 'Jardineira Floratta n80 Areia', 'jardineira_floratta_80'),
        ...
        new item(8, 'Jardineira Floratta n80 Rosa', 'jardineira_floratta_80'),
        ...
        new item(6, 'Kit Spinlock C/Rosca 5 Peças', 'kit_spinlock'),
        ...
        new item(4, 'Prato Vaso Coluna Floratta G Areia', 'prato_floratta_g'),
        new item(4, 'Prato Vaso Coluna Floratta G Preto', 'prato_floratta_g'),
        new item(4, 'Prato Vaso Coluna Floratta G Rosa', 'prato_floratta_g'),
        new item(4, 'Prato Vaso Coluna Floratta G Verde', 'prato_floratta_g'),

        new item(2, 'Prato Vaso Coluna Floratta M Areia', 'prato_floratta_m'),
        new item(2, 'Prato Vaso Coluna Floratta M Preto', 'prato_floratta_m'),
        new item(2, 'Prato Vaso Coluna Floratta M Rosa', 'prato_floratta_m'),
        new item(2, 'Prato Vaso Coluna Floratta M Verde', 'prato_floratta_m'),

        new item(2, 'Prato Vaso Coluna Floratta P Areia', 'prato_floratta_p'),
        new item(2, 'Prato Vaso Coluna Floratta P Preto', 'prato_floratta_p'),
        new item(2, 'Prato Vaso Coluna Floratta P Rosa', 'prato_floratta_p'),
        new item(2, 'Prato Vaso Coluna Floratta P Verde', 'prato_floratta_p'),
        ...
        new item(13, 'Pote Fliplock 800ml', 'fliplock'),
        ...
        new item(11, 'Vaso Coluna Floratta M Areia', 'vaso_coluna_m'),
        new item(31, 'Vaso Coluna Floratta M Preto', 'vaso_coluna_m'),
        new item(7, 'Vaso Coluna Floratta M Rosa', 'vaso_coluna_m'),
        new item(21, 'Vaso Coluna Floratta M Verde Escuro', 'vaso_coluna_m'),

        new item(12, 'Vaso Coluna Floratta G Areia', 'vaso_coluna_g'),
        new item(12, 'Vaso Coluna Floratta G Preto', 'vaso_coluna_g'),
        new item(12, 'Vaso Coluna Floratta G Rosa', 'vaso_coluna_g'),
        new item(22, 'Vaso Coluna Floratta G Verde Escuro', 'vaso_coluna_g'),

        new item(26, 'Vaso de Parede Bella Fiore 1.7 litros Areia', 'vp_florença_1.7'),
        new item(24, 'Vaso de Parede Bella Fiore 1.7 litros Cerâmica', 'vp_florença_1.7'),
        new item(28, 'Vaso de Parede Bella Fiore 1.7 litros Preto', 'vp_florença_1.7'),
        new item(24, 'Vaso de Parede Bella Fiore 1.7 litros Verde', 'vp_florença_1.7'),

        new item(18, 'Vaso de Parede Bella Fiore 3.3 litros Areia', 'vp_florença_3.3'),
        new item(36, 'Vaso de Parede Bella Fiore 3.3 litros Cerâmica', 'vp_florença_3.3'),
        new item(22, 'Vaso de Parede Bella Fiore 3.3 litros Preto', 'vp_florença_3.3'),
        new item(14, 'Vaso de Parede Bella Fiore 3.3 litros Verde', 'vp_florença_3.3'),

        new item(10, 'Vaso de Parede Floratta 3 litros Areia', 'vp_floratta_3'),
        new item(23, 'Vaso de Parede Floratta 3 litros Azul', 'vp_floratta_3'),
        new item(21, 'Vaso de Parede Floratta 3 litros cinza', 'vp_floratta_3'),
        new item(20, 'Vaso de Parede Floratta 3 litros Preto', 'vp_floratta_3'),
        new item(17, 'Vaso de Parede Floratta 3 litros Rosa', 'vp_floratta_3'),
        ...
        new item(21, 'Vaso de Parede Floratta 6 litros Preto', 'vp_floratta_6'),
        ...
        new item(19, 'Vaso de Parede Floratta 6 litros Verde Escuro', 'vp_floratta_6'),

        new item(62, 'Vaso Quadrado Bella Fiore n17 Areia', 'quadrado_n17'),
        new item(40, 'Vaso Quadrado Bella Fiore n17 Cerâmica', 'quadrado_n17'),
        new item(42, 'Vaso Quadrado Bella Fiore n17 Preto', 'quadrado_n17'),
        new item(16, 'Vaso Quadrado Bella Fiore n17 Verde', 'quadrado_n17'),

        new item(29, 'Vaso Quadrado Bella Fiore n22 Areia', 'quadrado_n22'),
        new item(19, 'Vaso Quadrado Bella Fiore n22 Cerâmica', 'quadrado_n22'),
        new item(27, 'Vaso Quadrado Bella Fiore n22 Preto', 'quadrado_n22'),
        new item(4, 'Vaso Quadrado Bella Fiore n22 Verde', 'quadrado_n22'),

        new item(38, 'Vaso Quadrado Bella Fiore n28 Areia', 'quadrado_n28'),
        new item(41, 'Vaso Quadrado Bella Fiore n28 Cerâmica', 'quadrado_n28'),
        new item(0, 'Vaso Quadrado Bella Fiore n28 Preto', 'quadrado_n28'),
        new item(17, 'Vaso Quadrado Bella Fiore n28 Verde', 'quadrado_n28'),

        new item(14, 'Vaso Quadrado Bella Fiore n35 Areia', 'quadrado_n35'),
        new item(3, 'Vaso Quadrado Bella Fiore n35 Cerâmica', 'quadrado_n35'),
        new item(28, 'Vaso Quadrado Bella Fiore n35 Preto', 'quadrado_n35'),
        new item(2, 'Vaso Quadrado Bella Fiore n35 Verde', 'quadrado_n35'),

        new item(14, 'Vaso Quadrado Bella Fiore n42 Areia', 'quadrado_n42'),
        new item(12, 'Vaso Quadrado Bella Fiore n42 Cerâmica', 'quadrado_n42'),
        new item(20, 'Vaso Quadrado Bella Fiore n42 Preto', 'quadrado_n42'),
        new item(6, 'Vaso Quadrado Bella Fiore n42 Verde', 'quadrado_n42'),

        new item(0, 'Vaso Redondo Bella Fiore n13 Areia', 'redondo_n13'),
        new item(44, 'Vaso Redondo Bella Fiore n13 Cerâmica', 'redondo_n13'),
        new item(50, 'Vaso Redondo Bella Fiore n13 Preto', 'redondo_n13'),
        new item(14, 'Vaso Redondo Bella Fiore n13 Verde', 'redondo_n13'),

        new item(50, 'Vaso Redondo Bella Fiore n17 Areia', 'redondo_n17'),
        new item(58, 'Vaso Redondo Bella Fiore n17 Cerâmica', 'redondo_n17'),
        new item(27, 'Vaso Redondo Bella Fiore n17 Preto', 'redondo_n17'),
        new item(14, 'Vaso Redondo Bella Fiore n17 Verde', 'redondo_n17'),

        new item(24, 'Vaso Redondo Bella Fiore n22 Areia', 'redondo_n22'),
        new item(27, 'Vaso Redondo Bella Fiore n22 Cerâmica', 'redondo_n22'),
        new item(18, 'Vaso Redondo Bella Fiore n22 Preto', 'redondo_n22'),
        new item(16, 'Vaso Redondo Bella Fiore n22 Verde', 'redondo_n22'),

        new item(36, 'Vaso Redondo Bella Fiore n28 Areia', 'redondo_n28'),
        new item(9, 'Vaso Redondo Bella Fiore n28 Cerâmica', 'redondo_n28'),
        new item(28, 'Vaso Redondo Bella Fiore n28 Preto', 'redondo_n28'),
        new item(14, 'Vaso Redondo Bella Fiore n28 Verde', 'redondo_n28'),

        new item(23, 'Vaso Redondo Bella Fiore n35 Areia', 'redondo_n35'),
        new item(15, 'Vaso Redondo Bella Fiore n35 Cerâmica', 'redondo_n35'),
        new item(21, 'Vaso Redondo Bella Fiore n35 Preto', 'redondo_n35'),
        new item(18, 'Vaso Redondo Bella Fiore n35 Verde', 'redondo_n35'),

        new item(28, 'Vaso Redondo Bella Fiore n42 Areia', 'redondo_n42'),
        new item(9, 'Vaso Redondo Bella Fiore n42 Cerâmica', 'redondo_n42'),
        new item(24, 'Vaso Redondo Bella Fiore n42 Preto', 'redondo_n42'),

        new item(14, 'Vaso Redondo Bella Fiore n50 Areia', 'redondo_n50'),
        new item(14, 'Vaso Redondo Bella Fiore n50 Cerâmica', 'redondo_n50'),
        new item(14, 'Vaso Redondo Bella Fiore n50 Preto', 'redondo_n50'),
        new item(6, 'Vaso Redondo Bella Fiore n50 Verde', 'redondo_n50'),

        new item(18, 'Vaso Quadrado Floratta n15 Areia', 'quadrado_floratta_15'),
        new item(18, 'Vaso Quadrado Floratta n15 Preto', 'quadrado_floratta_15'),
        new item(18, 'Vaso Quadrado Floratta n15 Rosa', 'quadrado_floratta_15'),
        new item(18, 'Vaso Quadrado Floratta n15 Verde Escuro', 'quadrado_floratta_15'),

        new item(8, 'Vaso Quadrado Floratta n19 Areia', 'quadrado_floratta_19'),
        new item(8, 'Vaso Quadrado Floratta n19 Preto', 'quadrado_floratta_19'),
        new item(8, 'Vaso Quadrado Floratta n19 Rosa', 'quadrado_floratta_19'),
        new item(8, 'Vaso Quadrado Floratta n19 Verde Escuro', 'quadrado_floratta_19'),

        new item(8, 'Vaso Quadrado Floratta n26 Areia', 'quadrado_floratta_26'),
        new item(8, 'Vaso Quadrado Floratta n26 Preto', 'quadrado_floratta_26'),
        new item(8, 'Vaso Quadrado Floratta n26 Rosa', 'quadrado_floratta_26'),
        new item(8, 'Vaso Quadrado Floratta n26 Verde Escuro', 'quadrado_floratta_26'),

        new item(8, 'Vaso Quadrado Floratta n33 Areia', 'quadrado_floratta_33'),
        new item(8, 'Vaso Quadrado Floratta n33 Preto', 'quadrado_floratta_33'),
        new item(8, 'Vaso Quadrado Floratta n33 Rosa', 'quadrado_floratta_33'),
        new item(8, 'Vaso Quadrado Floratta n33 Verde Escuro', 'quadrado_floratta_33'),

        new item(50, 'Vaso Redondo Floratta n15 Areia', 'redondo_floratta_15'),
        new item(56, 'Vaso Redondo Floratta n15 Preto', 'redondo_floratta_15'),
        new item(46, 'Vaso Redondo Floratta n15 Rosa', 'redondo_floratta_15'),
        new item(61, 'Vaso Redondo Floratta n15 Verde Escuro', 'redondo_floratta_15'),

        new item(26, 'Vaso Redondo Floratta n19 Areia', 'redondo_floratta_19'),
        new item(1, 'Vaso Redondo Floratta n19 cinza', 'redondo_floratta_19'),
        new item(25, 'Vaso Redondo Floratta n19 Preto', 'redondo_floratta_19'),
        new item(17, 'Vaso Redondo Floratta n19 Rosa', 'redondo_floratta_19'),
        new item(0, 'Vaso Redondo Floratta n19 Verde', 'redondo_floratta_19'),
        new item(29, 'Vaso Redondo Floratta n19 Verde Escuro', 'redondo_floratta_19'),

        new item(17, 'Vaso Redondo Floratta n26 Areia', 'redondo_floratta_26'),
        new item(3, 'Vaso Redondo Floratta n26 Azul', 'redondo_floratta_26'),
        new item(9, 'Vaso Redondo Floratta n26 cinza', 'redondo_floratta_26'),
        new item(24, 'Vaso Redondo Floratta n26 Preto', 'redondo_floratta_26'),
        new item(24, 'Vaso Redondo Floratta n26 Rosa', 'redondo_floratta_26'),
        new item(24, 'Vaso Redondo Floratta n26 Verde', 'redondo_floratta_26'),
        new item(23, 'Vaso Redondo Floratta n26 Verde Escuro', 'redondo_floratta_26'),

        new item(23, 'Vaso Redondo Floratta n33 Areia', 'redondo_floratta_33'),
        new item(39, 'Vaso Redondo Floratta n33 Azul', 'redondo_floratta_33'),
        new item(39, 'Vaso Redondo Floratta n33 cinza', 'redondo_floratta_33'),
        new item(23, 'Vaso Redondo Floratta n33 Preto', 'redondo_floratta_33'),
        new item(42, 'Vaso Redondo Floratta n33 Rosa', 'redondo_floratta_33'),
        new item(44, 'Vaso Redondo Floratta n33 Verde', 'redondo_floratta_33'),
        new item(31, 'Vaso Redondo Floratta n33 Verde Escuro', 'redondo_floratta_33'),

        new item(8, 'Vaso Redondo Floratta n40 Areia', 'redondo_floratta_40'),
        new item(29, 'Vaso Redondo Floratta n40 Azul', 'redondo_floratta_40'),
        new item(26, 'Vaso Redondo Floratta n40 cinza', 'redondo_floratta_40'),
        new item(16, 'Vaso Redondo Floratta n40 Preto', 'redondo_floratta_40'),
        new item(4, 'Vaso Redondo Floratta n40 Rosa', 'redondo_floratta_40'),
        ...
        new item(9, 'Vaso Redondo Floratta n50 Areia', 'redondo_floratta_50'),
        new item(13, 'Vaso Redondo Floratta n50 Preto', 'redondo_floratta_50'),
        new item(2, 'Vaso Redondo Floratta n50 Rosa', 'redondo_floratta_50'),
...
var emeAeme = new Inventario(
    ...
    [
        ...
        new item(98, 'Alça Universal Cerâmica', 'alça_universal'),
        new item(68, 'Alça Universal Marfim', 'alça_universal'),
        ...
        new item(41, 'Cuia CBB 18 Com Base Preta', 'cuia_cbb_18'),
        ...
        new item(26, 'Cuia CBB 21 Com Base Preta', 'cuia_cbb_21'),
        ...
        new item(59, 'Cuia CBB 25 Com Base Marfim', 'cuia_cbb_25'),
        ...
        new item(41, 'Cuia CBB 30 Com Base Cerâmica', 'cuia_cbb_30'),
        new item(46, 'Cuia CBB 30 Com Base Marfim', 'cuia_cbb_30'),
        new item(61, 'Cuia CBB 30 Com Base Preta', 'cuia_cbb_30'),
        new item(52, 'Cuia CBB 30 Com Base Verde', 'cuia_cbb_30'),

        new item(31, 'Cuia Gran Imperial CBB 40 Com Base Cerâmica', 'cuia_cbb_40'),
        ...
        new item(59, 'Prato B00 9.5cm Cerâmica', 'prato_b00'),
        new item(95, 'Prato B00 9.5cm Cimento', 'prato_b00'),
        new item(95, 'Prato B00 9.5cm Marfim', 'prato_b00'),
        new item(27, 'Prato B00 9.5cm Preto', 'prato_b00'),
        ...
        new item(192, 'Prato B01 11.5cm Preto', 'prato_b01'),
        ...
        new item(211, 'Prato B03 16cm Cerâmica', 'prato_b03'),
        new item(97, 'Prato B03 16cm Cimento', 'prato_b03'),
        new item(98, 'Prato B03 16cm Marfim', 'prato_b03'),
        new item(187, 'Prato B03 16cm Preto', 'prato_b03'),
        ...
        new item(133, 'Prato B04 21cm Preto', 'prato_b04'),
        ...
        new item(56, 'Prato B05 24cm Preto', 'prato_b05'),
        new item(20, 'Prato B05 24cm Verde', 'prato_b05'),

        new item(95, 'Prato B06 27cm Cerâmica', 'prato_b06'),
        ...
        new item(107, 'Prato B07 30cm Preto', 'prato_b07'),
        ...
        new item(36, 'Prato B09 38cm Cerâmica', 'prato_b09'),
        new item(35, 'Prato B09 38cm Cimento', 'prato_b09'),
        new item(35, 'Prato B09 38cm Marfim', 'prato_b09'),
        new item(59, 'Prato B09 38cm Preto', 'prato_b09'),
        ...
        new item(35, 'Vaso T 35 Cerâmica', 'vaso_t_35'),
...
var forth = new Inventario(
    ...
    [
        ...
        new item(13, 'Flores p/uso - 500ml', 'f'),
        new item(38, 'Flores - 400g', 'f'),
        new item(23, 'Flores - 3kg', 'f'),
        new item(0, 'Flores - 10Kg', 'f'),
        new item(29, 'Formicida Gel', 'f'),
        new item(0, 'Formicida isca granulada', 'f'), 
        new item(4, 'Formicida Mata no ninho p/uso - 500ml', 'f'),
        ...
        new item(35, 'Jardim - 400g', 'j'),
        new item(15, 'Jardim - 3kg', 'j'),

        new item(6, 'Lesmicida isca granulada', 'l'),

        new item(25, 'Mata cochonilha p/uso - 500ml', 'm'),
        new item(18, 'Mata lagarta p/uso - 500ml', 'm'),
        new item(18, 'Mata mato Concentrado - 30ml', 'm'),
        new item(5, 'Mata mato p/uso - 500ml', 'm'),
        new item(26, 'Mata pulgão p/uso - 500ml', 'm'),

        new item(24, 'Óleo Concentrado - 60ml', 'o'),
        new item(27, 'Orquídeas Floração Concentrado - 60ml', 'o'),
        new item(30, 'Orquídeas Floração p/uso - 500ml', 'o'),
        new item(38, 'Orquídeas Manutenção Concentrado - 60ml', 'o'),
        new item(24, 'Orquídeas Manutenção p/uso - 500ml', 'o'),
        new item(33, 'Orquídeas 09.45.15 - 100g', 'o'),
        new item(40, 'Orquídeas 20.20.20 - 100g', 'o'),
        new item(46, 'Orquídeas 30.10.10 - 100g', 'o'),
        new item(0, 'Orquídeas 09.45.15 - 400g', 'o'),
        new item(9, 'Orquídeas 20.20.20 - 400g', 'o'),
        new item(8, 'Orquídeas 30.10.10 - 400g', 'o'),

        new item(0, 'Palmeiras Concentrado - 60ml', 'p'),
        new item(8, 'Palmeiras p/uso - 500ml', 'p'),
        new item(37, 'Palmeiras - 400g', 'p'),
        new item(12, 'Palmeiras - 3kg', 'p'),
        new item(14, 'Pasta selante', 'p'),
        new item(9, 'Plantio - 400g', 'p'),
        new item(8, 'Plantio - 3kg', 'p'),
        new item(0, 'Plantio - 10kg', 'p'),

        new item(12, 'Raticida Bloco - 200g', 'r'),
        new item(20, 'Raticida Isca Anticoagulante', 'r'),
        new item(21, 'Rosa do Deserto Concentrado - 60ml', 'r'),
        new item(22, 'Rosa do Deserto p/uso - 500ml', 'r'),
        new item(10, 'Rosa do Deserto - 400g', 'r'),
        new item(2, 'Rosa do Deserto - 3kg', 'r'),

        new item(28, 'Samambaias Concentrado - 60ml', 's'),
        new item(20, 'Samambaias p/uso - 500ml', 's'),
        new item(28, 'Samambaias - 400g', 's'),
        new item(18, 'Suculentas Concentrado - 60ml', 's'),
...
var alfa_polietileno = new Inventario(
    ...
    [
        ...
        new item(11, 'Bacia Diamante nº 3 Bege', 'bacia_diamante_3'),
        new item(10, 'Bacia Diamante nº 3 Cimento', 'bacia_diamante_3'),
        new item(9, 'Bacia Diamante nº 3 Marrom', 'bacia_diamante_3'),
        new item(11, 'Bacia Diamante nº 3 Preto', 'bacia_diamante_3'),

        new item(3, 'Bacia Grafiato C/Prato nº 1 Bege', 'bacia_grafiato_1'),
        new item(8, 'Bacia Grafiato C/Prato nº 1 Chumbo', 'bacia_grafiato_1'),
        new item(5, 'Bacia Grafiato C/Prato nº 1 Cimento', 'bacia_grafiato_1'),
        new item(6, 'Bacia Grafiato C/Prato nº 1 Marrom', 'bacia_grafiato_1'),
        new item(9, 'Bacia Grafiato C/Prato nº 1 Preto', 'bacia_grafiato_1'),

        new item(5, 'Bacia Grafiato C/Prato nº 2 Bege', 'bacia_grafiato_2'),
        new item(4, 'Bacia Grafiato C/Prato nº 2 Chumbo', 'bacia_grafiato_2'),
        new item(8, 'Bacia Grafiato C/Prato nº 2 Cimento', 'bacia_grafiato_2'),
        new item(5, 'Bacia Grafiato C/Prato nº 2 Marrom', 'bacia_grafiato_2'),
        ...
        new item(8, 'Bacia Grafiato C/Prato nº 3 Chumbo', 'bacia_grafiato_3'),
        new item(9, 'Bacia Grafiato C/Prato nº 3 Cimento', 'bacia_grafiato_3'),
        new item(7, 'Bacia Grafiato C/Prato nº 3 Marrom', 'bacia_grafiato_3'),
        ...
        new item(8, 'Bacia Grafiato C/Prato nº 4 Chumbo', 'bacia_grafiato_4'),
        ...
        new item(4, 'Bacia Marmorizada C/Prato nº 1 Azul', 'bacia_marmorizada_1'),
        new item(7, 'Bacia Marmorizada C/Prato nº 1 Cimento Queimado', 'bacia_marmorizada_1'),
        new item(7, 'Bacia Marmorizada C/Prato nº 1 Verde', 'bacia_marmorizada_1'),
        new item(11, 'Bacia Marmorizada C/Prato nº 1 Vermelho', 'bacia_marmorizada_1'),

        new item(4, 'Bacia Marmorizada C/Prato nº 2 Azul', 'bacia_marmorizada_2'),
        new item(8, 'Bacia Marmorizada C/Prato nº 2 Cimento Queimado', 'bacia_marmorizada_2'),
        new item(10, 'Bacia Marmorizada C/Prato nº 2 Verde', 'bacia_marmorizada_2'),
        new item(7, 'Bacia Marmorizada C/Prato nº 2 Vermelho', 'bacia_marmorizada_2'),

        new item(6, 'Bacia Polida C/Prato nº 1 Bege', 'bacia_polida_1'),
        new item(6, 'Bacia Polida C/Prato nº 1 Cimento', 'bacia_polida_1'),
        new item(6, 'Bacia Polida C/Prato nº 1 Marrom', 'bacia_polida_1'),
        new item(8, 'Bacia Polida C/Prato nº 1 Preto', 'bacia_polida_1'),

        new item(8, 'Bacia Polida C/Prato nº 2 Bege', 'bacia_polida_2'),
        new item(7, 'Bacia Polida C/Prato nº 2 Cimento', 'bacia_polida_2'),
        new item(11, 'Bacia Polida C/Prato nº 2 Marrom', 'bacia_polida_2'),
        new item(6, 'Bacia Polida C/Prato nº 2 Preto', 'bacia_polida_2'),

        new item(8, 'Coluna Red. Degrau Grafiato C/Prato nº 1 Bege', 'coluna_degrau_1'),
        new item(8, 'Coluna Red. Degrau Grafiato C/Prato nº 1 Chumbo', 'coluna_degrau_1'),
        new item(10, 'Coluna Red. Degrau Grafiato C/Prato nº 1 Cimento', 'coluna_degrau_1'),
        new item(9, 'Coluna Red. Degrau Grafiato C/Prato nº 1 Marrom', 'coluna_degrau_1'),
        new item(10, 'Coluna Red. Degrau Grafiato C/Prato nº 1 Preto', 'coluna_degrau_1'),

        new item(9, 'Coluna Red. Degrau Grafiato C/Prato nº 2 Bege', 'coluna_degrau_2'),
        new item(8, 'Coluna Red. Degrau Grafiato C/Prato nº 2 Chumbo', 'coluna_degrau_2'),
        new item(9, 'Coluna Red. Degrau Grafiato C/Prato nº 2 Cimento', 'coluna_degrau_2'),
        ...
        new item(6, 'Coluna Red. Degrau Grafiato C/Prato nº 3 Chumbo', 'coluna_degrau_3'),
        new item(5, 'Coluna Red. Degrau Grafiato C/Prato nº 3 Cimento', 'coluna_degrau_3'),
        new item(7, 'Coluna Red. Degrau Grafiato C/Prato nº 3 Marrom', 'coluna_degrau_3'),
        new item(7, 'Coluna Red. Degrau Grafiato C/Prato nº 3 Preto', 'coluna_degrau_3'),

        new item(2, 'Coluna Red. Degrau Grafiato C/Prato nº 4 Bege', 'coluna_degrau_4'),
        new item(6, 'Coluna Red. Degrau Grafiato C/Prato nº 4 Chumbo', 'coluna_degrau_4'),
        ...
        new item(7, 'Coluna Red. Degrau Grafiato C/Prato nº 5 Bege', 'coluna_degrau_5'),
        new item(9, 'Coluna Red. Degrau Grafiato C/Prato nº 5 Chumbo', 'coluna_degrau_5'),
        new item(5, 'Coluna Red. Degrau Grafiato C/Prato nº 5 Cimento', 'coluna_degrau_5'),
        new item(5, 'Coluna Red. Degrau Grafiato C/Prato nº 5 Marrom', 'coluna_degrau_5'),
        new item(6, 'Coluna Red. Degrau Grafiato C/Prato nº 5 Preto', 'coluna_degrau_5'),

        new item(5, 'Coluna Red. Diamante C/Prato nº 1 Bege', 'coluna_diamante_1'),
        new item(9, 'Coluna Red. Diamante C/Prato nº 1 Chumbo', 'coluna_diamante_1'),
        new item(6, 'Coluna Red. Diamante C/Prato nº 1 Cimento', 'coluna_diamante_1'),
        new item(5, 'Coluna Red. Diamante C/Prato nº 1 Marrom', 'coluna_diamante_1'),
        new item(7, 'Coluna Red. Diamante C/Prato nº 1 Preta', 'coluna_diamante_1'),

        new item(8, 'Coluna Red. Diamante C/Prato nº 2 Bege', 'coluna_diamante_2'),
        new item(9, 'Coluna Red. Diamante C/Prato nº 2 Chumbo', 'coluna_diamante_2'),
        new item(8, 'Coluna Red. Diamante C/Prato nº 2 Cimento', 'coluna_diamante_2'),
        new item(5, 'Coluna Red. Diamante C/Prato nº 2 Marrom', 'coluna_diamante_2'),
        new item(6, 'Coluna Red. Diamante C/Prato nº 2 Preta', 'coluna_diamante_2'),

        new item(9, 'Coluna Red. Diamante C/Prato nº 3 Bege', 'coluna_diamante_3'),
        new item(9, 'Coluna Red. Diamante C/Prato nº 3 Chumbo', 'coluna_diamante_3'),
        new item(9, 'Coluna Red. Diamante C/Prato nº 3 Cimento', 'coluna_diamante_3'),
        new item(9, 'Coluna Red. Diamante C/Prato nº 3 Marrom', 'coluna_diamante_3'),
        new item(10, 'Coluna Red. Diamante C/Prato nº 3 Preta', 'coluna_diamante_3'),

        new item(9, 'Coluna Red. Diamante C/Prato nº 4 Bege', 'coluna_diamante_4'),
        new item(9, 'Coluna Red. Diamante C/Prato nº 4 Chumbo', 'coluna_diamante_4'),
        new item(8, 'Coluna Red. Diamante C/Prato nº 4 Cimento', 'coluna_diamante_4'),
        new item(8, 'Coluna Red. Diamante C/Prato nº 4 Marrom', 'coluna_diamante_4'),
        new item(7, 'Coluna Red. Diamante C/Prato nº 4 Preta', 'coluna_diamante_4'),

        new item(6, 'Coluna Red. Diamante C/Prato nº 5 Bege', 'coluna_diamante_5'),
        new item(9, 'Coluna Red. Diamante C/Prato nº 5 Chumbo', 'coluna_diamante_5'),
        new item(7, 'Coluna Red. Diamante C/Prato nº 5 Cimento', 'coluna_diamante_5'),
        new item(6, 'Coluna Red. Diamante C/Prato nº 5 Marrom', 'coluna_diamante_5'),
        new item(5, 'Coluna Red. Diamante C/Prato nº 5 Preta', 'coluna_diamante_5'),

        new item(6, 'Coluna Red. Grafiato C/Prato nº 1 Bege', 'coluna_grafiato_1'),
        new item(4, 'Coluna Red. Grafiato C/Prato nº 1 Chumbo', 'coluna_grafiato_1'),
        new item(10, 'Coluna Red. Grafiato C/Prato nº 1 Cimento', 'coluna_grafiato_1'),
        new item(8, 'Coluna Red. Grafiato C/Prato nº 1 Marrom', 'coluna_grafiato_1'),
        new item(9, 'Coluna Red. Grafiato C/Prato nº 1 Preto', 'coluna_grafiato_1'),

        new item(6, 'Coluna Red. Grafiato C/Prato nº 2 Bege', 'coluna_grafiato_2'),
        new item(8, 'Coluna Red. Grafiato C/Prato nº 2 Chumbo', 'coluna_grafiato_2'),
        new item(8, 'Coluna Red. Grafiato C/Prato nº 2 Cimento', 'coluna_grafiato_2'),
        new item(5, 'Coluna Red. Grafiato C/Prato nº 2 Marrom', 'coluna_grafiato_2'),
        new item(6, 'Coluna Red. Grafiato C/Prato nº 2 Preto', 'coluna_grafiato_2'),

        new item(4, 'Coluna Red. Grafiato C/Prato nº 3 Bege', 'coluna_grafiato_3'),
        new item(8, 'Coluna Red. Grafiato C/Prato nº 3 Chumbo', 'coluna_grafiato_3'),
        new item(5, 'Coluna Red. Grafiato C/Prato nº 3 Cimento', 'coluna_grafiato_3'),
        new item(10, 'Coluna Red. Grafiato C/Prato nº 3 Marrom', 'coluna_grafiato_3'),
        new item(9, 'Coluna Red. Grafiato C/Prato nº 3 Preto', 'coluna_grafiato_3'),

        new item(5, 'Coluna Red. Grafiato C/Prato nº 4 Bege', 'coluna_grafiato_4'),
        new item(6, 'Coluna Red. Grafiato C/Prato nº 4 Chumbo', 'coluna_grafiato_4'),
        new item(10, 'Coluna Red. Grafiato C/Prato nº 4 Cimento', 'coluna_grafiato_4'),
        new item(7, 'Coluna Red. Grafiato C/Prato nº 4 Marrom', 'coluna_grafiato_4'),
        new item(11, 'Coluna Red. Grafiato C/Prato nº 4 Preto', 'coluna_grafiato_4'),

        new item(5, 'Coluna Red. Marmorizada C/Prato nº 1 Azul', 'coluna_marmorizada_1'),
        new item(7, 'Coluna Red. Marmorizada C/Prato nº 1 Cimento Queimado', 'coluna_marmorizada_1'),
        new item(9, 'Coluna Red. Marmorizada C/Prato nº 1 verde', 'coluna_marmorizada_1'),
        new item(3, 'Coluna Red. Marmorizada C/Prato nº 1 Vermelho', 'coluna_marmorizada_1'),

        new item(4, 'Coluna Red. Marmorizada C/Prato nº 2 Azul', 'coluna_marmorizada_2'),
        new item(8, 'Coluna Red. Marmorizada C/Prato nº 2 Cimento Queimado', 'coluna_marmorizada_2'),
        new item(14, 'Coluna Red. Marmorizada C/Prato nº 2 verde', 'coluna_marmorizada_2'),
        new item(4, 'Coluna Red. Marmorizada C/Prato nº 2 Vermelho', 'coluna_marmorizada_2'),

        new item(0, 'Coluna Red. Marmorizada C/Prato nº 3 Azul', 'coluna_marmorizada_3'),
        new item(0, 'Coluna Red. Marmorizada C/Prato nº 3 Cimento Queimado', 'coluna_marmorizada_3'),
        ...
        new item(6, 'Coluna Red. Marmorizada C/Prato nº 4 Cimento Queimado', 'coluna_marmorizada_4'),
        new item(6, 'Coluna Red. Marmorizada C/Prato nº 4 verde', 'coluna_marmorizada_4'),
        new item(6, 'Coluna Red. Marmorizada C/Prato nº 4 Vermelho', 'coluna_marmorizada_4'),

        new item(7, 'Coluna Red. Polida C/Prato nº 1 Bege', 'coluna_polida_1'),
        ...
        new item(7, 'Coluna Red. Polida C/Prato nº 1 Preto', 'coluna_polida_1'),

        new item(2, 'Coluna Red. Polida C/Prato nº 2 Bege', 'coluna_polida_2'),
        new item(7, 'Coluna Red. Polida C/Prato nº 2 Cimento', 'coluna_polida_2'),
        ...
        new item(4, 'Coluna Red. Polida C/Prato nº 3 Bege', 'coluna_polida_3'),
        ...
        new item(2, 'Coluna Red. Polida C/Prato nº 3 Preto', 'coluna_polida_3'),

        new item(4, 'Coluna Red. Polida C/Prato nº 4 Bege', 'coluna_polida_4'),
        new item(5, 'Coluna Red. Polida C/Prato nº 4 Cimento', 'coluna_polida_4'),
        new item(3, 'Coluna Red. Polida C/Prato nº 4 Marrom', 'coluna_polida_4'),
        new item(4, 'Coluna Red. Polida C/Prato nº 4 Preto', 'coluna_polida_4'),

        new item(4, 'Jardineira Frisada C/Prato Bege', 'jardineira_frisada_1'),
        new item(2, 'Jardineira Frisada C/Prato Chumbo', 'jardineira_frisada_1'),
        new item(0, 'Jardineira Frisada C/Prato Preto', 'jardineira_frisada_1'),

        new item(3, 'Jardineira Grafiato C/Prato nº 1 Bege', 'jardineira_grafiato_1'),
        new item(2, 'Jardineira Grafiato C/Prato nº 1 Chumbo', 'jardineira_grafiato_1'),
        new item(0, 'Jardineira Grafiato C/Prato nº 1 Cimento', 'jardineira_grafiato_1'),
        new item(3, 'Jardineira Grafiato C/Prato nº 1 Marrom', 'jardineira_grafiato_1'),
        new item(0, 'Jardineira Grafiato C/Prato nº 1 Preto', 'jardineira_grafiato_1'),

        new item(6, 'Jardineira Grafiato C/Prato nº 2 Bege', 'jardineira_grafiato_2'),
        new item(1, 'Jardineira Grafiato C/Prato nº 2 Chumbo', 'jardineira_grafiato_2'),
        new item(2, 'Jardineira Grafiato C/Prato nº 2 Marrom', 'jardineira_grafiato_2'),
        new item(5, 'Jardineira Grafiato C/Prato nº 2 Preto', 'jardineira_grafiato_2'),

        new item(8, 'Vaso Bojo Red. Diamante C/Prato nº 1 Bege', 'vaso_diamante_1'),
        new item(8, 'Vaso Bojo Red. Diamante C/Prato nº 1 Chumbo', 'vaso_diamante_1'),
        ...
        new item(9, 'Vaso Bojo Red. Diamante C/Prato nº 2 Chumbo', 'vaso_diamante_2'),
        ...
        new item(9, 'Vaso Bojo Red. Diamante C/Prato nº 3 Chumbo', 'vaso_diamante_3'),
        new item(9, 'Vaso Bojo Red. Diamante C/Prato nº 3 Cimento', 'vaso_diamante_3'),
        new item(7, 'Vaso Bojo Red. Diamante C/Prato nº 3 Marrom', 'vaso_diamante_3'),
        new item(7, 'Vaso Bojo Red. Diamante C/Prato nº 3 Preto', 'vaso_diamante_3'),

        new item(15, 'Vaso Bojo Red. Diamante C/Prato nº 4 Bege', 'vaso_diamante_4'),
        new item(8, 'Vaso Bojo Red. Diamante C/Prato nº 4 Chumbo', 'vaso_diamante_4'),
        new item(14, 'Vaso Bojo Red. Diamante C/Prato nº 4 Cimento', 'vaso_diamante_4'),
        new item(6, 'Vaso Bojo Red. Diamante C/Prato nº 4 Marrom', 'vaso_diamante_4'),
        new item(13, 'Vaso Bojo Red. Diamante C/Prato nº 4 Preto', 'vaso_diamante_4'),

        new item(6, 'Vaso Bojo Frisado C/Prato nº 1 Bege', 'vaso_frisado_1'),
        new item(8, 'Vaso Bojo Frisado C/Prato nº 1 Chumbo', 'vaso_frisado_1'),
        ...
        new item(8, 'Vaso Bojo Frisado C/Prato nº 2 Chumbo', 'vaso_frisado_2'),
        ...
        new item(6, 'Vaso Bojo Frisado C/Prato nº 2 Preto', 'vaso_frisado_2'),

        new item(5, 'Vaso Bojo Frisado C/Prato nº 3 Bege', 'vaso_frisado_3'),
        new item(8, 'Vaso Bojo Frisado C/Prato nº 3 Chumbo', 'vaso_frisado_3'),
        new item(8, 'Vaso Bojo Frisado C/Prato nº 3 Cimento', 'vaso_frisado_3'),
        new item(6, 'Vaso Bojo Frisado C/Prato nº 3 Marrom', 'vaso_frisado_3'),
        ...
        new item(8, 'Vaso Bojo Frisado C/Prato nº 4 Chumbo', 'vaso_frisado_4'),
        new item(12, 'Vaso Bojo Frisado C/Prato nº 4 Cimento', 'vaso_frisado_4'),
        new item(9, 'Vaso Bojo Frisado C/Prato nº 4 Marrom', 'vaso_frisado_4'),
        new item(14, 'Vaso Bojo Frisado C/Prato nº 4 Preto', 'vaso_frisado_4'),

        new item(6, 'Vaso Bojo Red. Grafiato C/Prato nº 1 Bege', 'vaso_grafiato_1'),
        new item(8, 'Vaso Bojo Red. Grafiato C/Prato nº 1 Chumbo', 'vaso_grafiato_1'),
        new item(2, 'Vaso Bojo Red. Grafiato C/Prato nº 1 Cimento', 'vaso_grafiato_1'),
        new item(6, 'Vaso Bojo Red. Grafiato C/Prato nº 1 Marrom', 'vaso_grafiato_1'),
        new item(0, 'Vaso Bojo Red. Grafiato C/Prato nº 1 Preto', 'vaso_grafiato_1'),

        new item(2, 'Vaso Bojo Red. Grafiato C/Prato nº 2 Bege', 'vaso_grafiato_2'),
        new item(6, 'Vaso Bojo Red. Grafiato C/Prato nº 2 Chumbo', 'vaso_grafiato_2'),
        new item(1, 'Vaso Bojo Red. Grafiato C/Prato nº 2 Cimento', 'vaso_grafiato_2'),
        new item(3, 'Vaso Bojo Red. Grafiato C/Prato nº 2 Marrom', 'vaso_grafiato_2'),
        new item(6, 'Vaso Bojo Red. Grafiato C/Prato nº 2 Preto', 'vaso_grafiato_2'),

        new item(7, 'Vaso Bojo Red. Grafiato C/Prato nº 3 Bege', 'vaso_grafiato_3'),
        new item(8, 'Vaso Bojo Red. Grafiato C/Prato nº 3 Chumbo', 'vaso_grafiato_3'),
        ...
        new item(8, 'Vaso Bojo Red. Grafiato C/Prato nº 4 Chumbo', 'vaso_grafiato_4'),
        new item(4, 'Vaso Bojo Red. Grafiato C/Prato nº 4 Cimento', 'vaso_grafiato_4'),
        new item(4, 'Vaso Bojo Red. Grafiato C/Prato nº 4 Marrom', 'vaso_grafiato_4'),
        new item(5, 'Vaso Bojo Red. Grafiato C/Prato nº 4 Preto', 'vaso_grafiato_4'),

        new item(4, 'Vaso Bojo Red. Lisboa C/Prato nº 1 Bege', 'vaso_Lisboa_1'),
        new item(4, 'Vaso Bojo Red. Lisboa C/Prato nº 1 Chumbo', 'vaso_Lisboa_1'),
        new item(4, 'Vaso Bojo Red. Lisboa C/Prato nº 1 Cimento', 'vaso_Lisboa_1'),
        new item(4, 'Vaso Bojo Red. Lisboa C/Prato nº 1 Marrom', 'vaso_Lisboa_1'),
        new item(4, 'Vaso Bojo Red. Lisboa C/Prato nº 1 Preto', 'vaso_Lisboa_1'),

        new item(6, 'Vaso Bojo Red. Lisboa C/Prato nº 2 Bege', 'vaso_Lisboa_2'),
        new item(8, 'Vaso Bojo Red. Lisboa C/Prato nº 2 Chumbo', 'vaso_Lisboa_2'),
        new item(8, 'Vaso Bojo Red. Lisboa C/Prato nº 2 Cimento', 'vaso_Lisboa_2'),
        ...
        new item(1, 'Vaso Bojo Red. Marmorizado C/Prato nº 1 Azul', 'vaso_marmorizado_1'),
        new item(7, 'Vaso Bojo Red. Marmorizado C/Prato nº 1 Cimento Queimado', 'vaso_marmorizado_1'),
        new item(7, 'Vaso Bojo Red. Marmorizado C/Prato nº 1 Verde', 'vaso_marmorizado_1'),
        ...
        new item(6, 'Vaso Bojo Red. Marmorizado C/Prato nº 2 Cimento Queimado', 'vaso_marmorizado_2'),
        new item(6, 'Vaso Bojo Red. Marmorizado C/Prato nº 2 Verde', 'vaso_marmorizado_2'),
        ...
        new item(8, 'Vaso Bojo Red. Marmorizado C/Prato nº 3 Cimento Queimado', 'vaso_marmorizado_3'),
        new item(8, 'Vaso Bojo Red. Marmorizado C/Prato nº 3 Verde', 'vaso_marmorizado_3'),
        new item(4, 'Vaso Bojo Red. Marmorizado C/Prato nº 3 Vermelho', 'vaso_marmorizado_3'),

        new item(10, 'Vaso Bojo Red. Polido C/Prato nº 1 Bege', 'vaso_polido_1'),
        new item(9, 'Vaso Bojo Red. Polido C/Prato nº 1 Cimento', 'vaso_polido_1'),
        new item(11, 'Vaso Bojo Red. Polido C/Prato nº 1 Marrom', 'vaso_polido_1'),
        new item(10, 'Vaso Bojo Red. Polido C/Prato nº 1 Preto', 'vaso_polido_1'),

        new item(8, 'Vaso Bojo Red. Polido C/Prato nº 2 Bege', 'vaso_polido_2'),
        new item(5, 'Vaso Bojo Red. Polido C/Prato nº 2 Cimento', 'vaso_polido_2'),
        ...
        new item(6, 'Vaso Bojo Red. Polido C/Prato nº 3 Cimento', 'vaso_polido_3'),
        new item(9, 'Vaso Bojo Red. Polido C/Prato nº 3 Marrom', 'vaso_polido_3'),
        ...
        new item(0, 'Vaso Origame C/Prato nº 1 Bege', 'vaso_origame_1'),
        new item(1, 'Vaso Origame C/Prato nº 1 Chumbo', 'vaso_origame_1'),
        new item(2, 'Vaso Origame C/Prato nº 1 Cimento', 'vaso_origame_1'),
        new item(0, 'Vaso Origame C/Prato nº 1 Marrom', 'vaso_origame_1'),
        new item(2, 'Vaso Origame C/Prato nº 1 Preto', 'vaso_origame_1'),

        new item(3, 'Vaso Origame C/Prato nº 3 Bege', 'vaso_origame_3'),
        new item(4, 'Vaso Origame C/Prato nº 3 Chumbo', 'vaso_origame_3'),
        new item(7, 'Vaso Origame C/Prato nº 3 Cimento', 'vaso_origame_3'),
        new item(8, 'Vaso Origame C/Prato nº 3 Marrom', 'vaso_origame_3'),
        new item(8, 'Vaso Origame C/Prato nº 3 Preto', 'vaso_origame_3')
    ]
)
var alfa_fibraSintetica = new Inventario(
    ...
    [
        ...
        new item(10, "Cuia Sem Borda nº 0 Café", 'cuia_0'),
        new item(0, "Cuia Sem Borda nº 0 Envelhecido", 'cuia_0'),
        new item(10, "Cuia Sem Borda nº 0 Palha", 'cuia_0'),

        new item(18, "Cuia Sem Borda nº 1 Argila", 'cuia_1'),
        new item(2, "Cuia Sem Borda nº 1 Branco", 'cuia_1'),
        new item(8, "Cuia Sem Borda nº 1 Café", 'cuia_1'),
        new item(10, "Cuia Sem Borda nº 1 Cappuccino", 'cuia_1'),
        new item(13, "Cuia Sem Borda nº 1 Envelhecido", 'cuia_1'),
        new item(10, "Cuia Sem Borda nº 1 Palha", 'cuia_1'),

        new item(10, "Cuia Sem Borda nº 2 Argila", 'cuia_2'),
        new item(0, "Cuia Sem Borda nº 2 Branco", 'cuia_2'),
        new item(8, "Cuia Sem Borda nº 2 Cafe", 'cuia_2'),
        new item(8, "Cuia Sem Borda nº 2 Cappuccino", 'cuia_2'),
        new item(8, "Cuia Sem Borda nº 2 Envelhecido", 'cuia_2'),
        new item(10, "Cuia Sem Borda nº 2 Palha", 'cuia_2'),

        new item(27, "Cuia Sem Borda nº 3 Argila", 'cuia_3'),
        new item(0, "Cuia Sem Borda nº 3 Branco", 'cuia_3'),
        new item(8, "Cuia Sem Borda nº 3 Cafe", 'cuia_3'),
        new item(9, "Cuia Sem Borda nº 3 Cappuccino", 'cuia_3'),
        new item(5, "Cuia Sem Borda nº 3 Envelhecido", 'cuia_3'),
        new item(23, "Cuia Sem Borda nº 3 Palha", 'cuia_3'),

        new item(12, "Cuia Sem Borda nº 4 Argila", 'cuia_4'),
        new item(0, "Cuia Sem Borda nº 4 Branco", 'cuia_4'),
        new item(6, "Cuia Sem Borda nº 4 Cafe", 'cuia_4'),
        new item(8, "Cuia Sem Borda nº 4 Cappuccino", 'cuia_4'),
        new item(9, "Cuia Sem Borda nº 4 Envelhecido", 'cuia_4'),
        new item(14, "Cuia Sem Borda nº 4 Palha", 'cuia_4'),
       
        new item(3, "Cachepot Cacau nº 1 Branco", "cachepot_cacau_1"),
        new item(3, "Cachepot Cacau nº 1 Bege", "cachepot_cacau_1"),
        new item(3, "Cachepot Cacau nº 1 Cinza", "cachepot_cacau_1"),
        new item(3, "Cachepot Cacau nº 1 Preto", "cachepot_cacau_1"),
        new item(3, "Cachepot Cacau nº 1 Rose", "cachepot_cacau_1"),
        new item(3, "Cachepot Cacau nº 1 Terra Cota", "cachepot_cacau_1"),
        
        new item(4, "Cachepot Cacau nº 2 Branco", "cachepot_cacau_2"),
        new item(4, "Cachepot Cacau nº 2 Bege", "cachepot_cacau_2"),
        new item(4, "Cachepot Cacau nº 2 Cinza", "cachepot_cacau_2"),
        new item(4, "Cachepot Cacau nº 2 Preto", "cachepot_cacau_2"),
        new item(4, "Cachepot Cacau nº 2 Rose", "cachepot_cacau_2"),
        new item(4, "Cachepot Cacau nº 2 Terra Cota", "cachepot_cacau_2"),

        new item(4, "Cachepot Cacau nº 3 Branco", "cachepot_cacau_3"),
        new item(4, "Cachepot Cacau nº 3 Bege", "cachepot_cacau_3"),
        new item(4, "Cachepot Cacau nº 3 Cinza", "cachepot_cacau_3"),
        new item(4, "Cachepot Cacau nº 3 Preto", "cachepot_cacau_3"),
        new item(4, "Cachepot Cacau nº 3 Rose", "cachepot_cacau_3"),
        new item(4, "Cachepot Cacau nº 3 Terra Cota", "cachepot_cacau_3"),

        new item(6, "Cachepot Prisma nº 1 Branco", "cachepot_prisma_1"),
        new item(4, "Cachepot Prisma nº 1 Bege", "cachepot_prisma_1"),
        new item(4, "Cachepot Prisma nº 1 Cinza", "cachepot_prisma_1"),
        new item(6, "Cachepot Prisma nº 1 Preto", "cachepot_prisma_1"),
        new item(4, "Cachepot Prisma nº 1 Rose", "cachepot_prisma_1"),
        new item(4, "Cachepot Prisma nº 1 Terra Cota", "cachepot_prisma_1"),

        new item(6, "Cachepot Prisma nº 2 Branco", "cachepot_prisma_2"),
        new item(4, "Cachepot Prisma nº 2 Bege", "cachepot_prisma_2"),
        new item(4, "Cachepot Prisma nº 2 Cinza", "cachepot_prisma_2"),
        new item(6, "Cachepot Prisma nº 2 Preto", "cachepot_prisma_2"),
        new item(4, "Cachepot Prisma nº 2 Rose", "cachepot_prisma_2"),
        new item(4, "Cachepot Prisma nº 2 Terra Cota", "cachepot_prisma_2"),
        
        new item(6, "Cachepot Prisma nº 3 Branco", "cachepot_prisma_3"),
        new item(4, "Cachepot Prisma nº 3 Bege", "cachepot_prisma_3"),
        new item(4, "Cachepot Prisma nº 3 Cinza", "cachepot_prisma_3"),
        new item(6, "Cachepot Prisma nº 3 Preto", "cachepot_prisma_3"),
        new item(4, "Cachepot Prisma nº 3 Rose", "cachepot_prisma_3"),
        new item(4, "Cachepot Prisma nº 3 Terra Cota", "cachepot_prisma_3"),

        new item(16, "Cachepot Cactos nº 1 Argila", 'cactus_1'),
        new item(5, "Cachepot Cactos nº 1 Braco", 'cactus_1'),
        new item(10, "Cachepot Cactos nº 1 Café", 'cactus_1'),
        new item(10, "Cachepot Cactos nº 1 Cappuccino", 'cactus_1'),
        new item(16, "Cachepot Cactos nº 1 Envelhecido", 'cactus_1'),
        new item(15, "Cachepot Cactos nº 1 Palha", 'cactus_1'),

        new item(19, "Cachepot Cactos nº 2 Argila", 'cactus_2'),
        new item(5, "Cachepot Cactos nº 2 Braco", 'cactus_2'),
        new item(3, "Cachepot Cactos nº 2 Café", 'cactus_2'),
        new item(15, "Cachepot Cactos nº 2 Cappuccino", 'cactus_2'),
        new item(8, "Cachepot Cactos nº 2 Envelhecido", 'cactus_2'),
        new item(11, "Cachepot Cactos nº 2 Palha", 'cactus_5'),

        new item(20, "Cachepot Cactos nº 3 Argila", 'cactus_3'),
        new item(6, "Cachepot Cactos nº 3 Braco", 'cactus_3'),
        new item(10, "Cachepot Cactos nº 3 Café", 'cactus_3'),
        new item(11, "Cachepot Cactos nº 3 Cappuccino", 'cactus_3'),
        new item(18, "Cachepot Cactos nº 3 Envelhecido", 'cactus_3'),
        new item(10, "Cachepot Cactos nº 3 Palha", 'cactus_3'),

        new item(10, "Cachepot Sem Borda nº 1 Argila", 'cachepot_1'),
        new item(0, "Cachepot Sem Borda nº 1 Braco", 'cachepot_1'),
        new item(16, "Cachepot Sem Borda nº 1 Café", 'cachepot_1'),
        new item(7, "Cachepot Sem Borda nº 1 Cappuccino", 'cachepot_1'),
        new item(0,  "Cachepot Sem Borda nº 1 Envelhecido", 'cachepot_1'),
        new item(10, "Cachepot Sem Borda nº 1 Palha", 'cachepot_1'),

        new item(20, "Cachepot Sem Borda nº 2 Argila", 'cachepot_2'),
        new item(0, "Cachepot Sem Borda nº 2 Braco", 'cachepot_2'),
        new item(20, "Cachepot Sem Borda nº 2 Café", 'cachepot_2'),
        new item(18, "Cachepot Sem Borda nº 2 Cappuccino", 'cachepot_2'),
        new item(0, "Cachepot Sem Borda nº 2 Envelhecido", 'cachepot_2'),
        new item(20, "Cachepot Sem Borda nº 2 Palha", 'cachepot_2'),

        new item(22, "Cachepot Sem Borda nº 3 Argila", 'cachepot_3'),
        new item(0, "Cachepot Sem Borda nº 3 Braco", 'cachepot_3'),
        new item(18, "Cachepot Sem Borda nº 3 Café", 'cachepot_3'),
        ...
        new item(3, "Coluna Quadrada nº 2 Argila", 'coluna_2'),
        new item(2, "Coluna Quadrada nº 2 Café", 'coluna_2'),
        new item(2, "Coluna Quadrada nº 2 Cappuccino", 'coluna_2'),
        new item(2, "Coluna Quadrada nº 2 Envelhecido", 'coluna_2'),

        new item(4, "Coluna Quadrada nº 3 Argila", 'coluna_3'),
        new item(1, "Coluna Quadrada nº 3 Café", 'coluna_3'),
        new item(1, "Coluna Quadrada nº 3 Cappuccino", 'coluna_3'),
        new item(2, "Coluna Quadrada nº 3 Envelhecido", 'coluna_3'),

        new item(10, "Vaso Red. Sem Borda nº 1 Argila", 'vaso_1'),
        new item(10, "Vaso Red. Sem Borda nº 1 Café", 'vaso_1'),
        new item(4, "Vaso Red. Sem Borda nº 1 Cappuccino", 'vaso_1'),
        new item(4, "Vaso Red. Sem Borda nº 1 Envelhecido", 'vaso_1'),

        new item(10, "Vaso Red. Sem Borda nº 2 Argila", 'vaso_2'),
        new item(10, "Vaso Red. Sem Borda nº 2 Café", 'vaso_2'),
        new item(0, "Vaso Red. Sem Borda nº 2 Cappuccino", 'vaso_2'),
        new item(0, "Vaso Red. Sem Borda nº 2 Envelhecido", 'vaso_2'),

        new item(10, "Vaso Red. Sem Borda nº 3 Argila", 'vaso_3'),
        new item(10, "Vaso Red. Sem Borda nº 3 Café", 'vaso_3'),
        new item(4, "Vaso Red. Sem Borda nº 3 Cappuccino", 'vaso_3'),
        new item(4, "Vaso Red. Sem Borda nº 3 Envelhecido", 'vaso_3'),

        new item(10, "Vaso Red. Sem Borda nº 4 Argila", 'vaso_4'),
        new item(10, "Vaso Red. Sem Borda nº 4 Café", 'vaso_4'),
...
var policamp = new Inventario(
    ...
    '02/04/2024',
    [
        new item(36, 'Pulverizador 500ml', 'pulverizador'),
        ...
        new item(96, 'Regador - 2 litros', 'Regador'),
        new item(116, 'Regador - 4 litros', 'Regador'),
        new item(88, 'Regador - 5 litros', 'Regador'),
        new item(54, 'Regador - 10 litros', 'Regador')
    ]
)
var jel_plast = new Inventario(
    ...
    '02/04/2024',
    [
        new item(157, 'Bebedouro Beija Flor Bandeija REF20', 'bebedouro'),
        new item(116, 'Bebedouro Beija Flor Luxo Chapeu Com Poleiro REF50', 'bebedouro'),
...
var insetimax = new Inventario(
    ...
    [
        ...
        new item(55, 'Formicida Insetimaster - 100ml', 'formicida'),
        new item(14, 'Formicida Insetimaster - 1 litro', 'formicida'),

        new item(10, 'Inseticon Display 20 Unidades', 'inseticom'),
...
var madeiras = new Inventario(
    ...
    [
        ...
        new item(10, 'Cachepo Madeira 20 Simples', 'cachepo'),
        new item(4, 'Cachepo Madeira 20 Pintado', 'cachepo'),
        new item(7, 'Cachepo Madeira 40 Simples', 'cachepo'),
        new item(7, 'Cachepo Madeira 40 Pintado', 'cachepo'),

        new item(12, 'Rodízio Redondo 20cm', 'rodízio_redondo'),
        new item(12, 'Rodízio Redondo 25cm', 'rodízio_redondo'),
        new item(1, 'Rodízio Redondo 30cm', 'rodízio_redondo'),
        new item(15, 'Rodízio Redondo 35cm', 'rodízio_redondo'),
        new item(3, 'Rodízio Redondo 40cm', 'rodízio_redondo'),
        new item(3, 'Rodízio Redondo 45cm', 'rodízio_redondo'),
        new item(0, 'Rodízio Redondo 50cm', 'rodízio_redondo'),

        new item(8, 'Rodízio Quadrado 20cm', 'rodízio_quadrado'),
        new item(8, 'Rodízio Quadrado 25cm', 'rodízio_quadrado'),
        new item(9, 'Rodízio Quadrado 30cm', 'rodízio_quadrado'),
        ...
        new item(2, 'Rodízio Quadrado 50cm', 'rodízio_quadrado'),
    ]
)
...
var coquim = new Inventario(
    ...
    '02/04/2024',
    [
        new item(7, '999 - Vaso Coquim nº 3', 'vaso_coquim'),
        new item(9, '1000 - Vaso Coquim nº 4', 'vaso_coquim'),
        new item(8, '1001 - Vaso Coquim nº 5', 'vaso_coquim'),
        ...
        new item(5, '2007 - Placa Redonda Coquim 20cm', 'placa_redonda'),
        new item(5, '2008 - Placa Redonda Coquim 25cm', 'placa_redonda'),
        new item(5, '2009 - Placa Redonda Coquim 30cm', 'placa_redonda'),
        new item(4, '2010 - Placa Redonda Coquim 35cm', 'placa_redonda'),
        new item(3, '2011 - Placa Redonda Coquim 40cm', 'placa_redonda'),
        new item(6, '2012 - Placa Redonda Coquim 50cm', 'placa_redonda'),
        ...
        new item(27, '4000 - Mix Coquim 1kg', 'adubos'),
        ...
        new item(32, '4005 - Chips de Coco 200g', 'adubos'),
        new item(35, '4006 - Fibra de Coco Protein', 'adubos'),
        new item(29, '4007 - Chips de Mix Protem 1kg', 'adubos'),
        ...
        new item(12, '4011 - Musgo Esfagno 100g', 'adubos'),
        new item(29, '4012 - Fibra Curta 250g', 'adubos'),
        ...
        new item(3, '6001 - Manta Calandrada 1.00mx1.00m 4mm', 'manta'),
        new item(6, '6007 - Manta Calandrada 50cmx2.00m 4mm', 'manta'),
        new item(8, '6008 - Manta 1mm 0.5x2m', 'manta'),
        ...
        new item(6, '6019 - Manta Calandrada 50cmx1.00m 4mm', 'manta'),
        ...
        new item(3, '7002 - 1/2 Vaso nº 17 C/Placa Media 29x26cm', '1/2_vaso_placa'),
