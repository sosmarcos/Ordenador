...
var diversos = new Inventario(
    ...
    [
        ...
        new item(15, 'Cuia GP Ceramica', 'cuia_gp'),
        new item(17, 'Cuia GP Preta', 'cuia_gp'),
        new item(19, 'Cuia GP Vermelha', 'cuia_gp'),
        ...
        new item(24, 'Mini Floreira Branco', 'mini_floreira'),
        new item(0, 'Mini Floreira Laranja', 'mini_floreira'),
        new item(24, 'Mini Floreira Marrom', 'mini_floreira'),
        new item(41, 'Mini Floreira Preto', 'mini_floreira'),
        new item(14, 'Mini Floreira Rosa', 'mini_floreira'),
...
var regaplan = new Inventario(
    ...
    [
        ...
        new item(46, 'Suporte A Reforçado 03 - 29cm Dourado', 'sp_a_reforçado'),
        new item(39, 'Suporte A Reforçado 04 - 34cm Dourado', 'sp_a_reforçado'),
        ...
        new item(5, 'Suporte Coador 28cm Preto', 'sp_coador'),
        new item(13, 'Suporte Coador 30cm Preto', 'sp_coador'),
        new item(7, 'Suporte Coador 32cm Preto', 'sp_coador'),
        ...
        new item(25, 'Suporte Rasteiro Chapa 04 - 27cm Dourado', 'sp_rasteiro'),
        ...
        new item(5, 'Suporte Torre 40cm Preto', 'sp_torre'),
        new item(5, 'Suporte Torre 60cm Dourado', 'sp_torre'),
        new item(10, 'Suporte Torre 60cm Preto', 'sp_torre'),
        new item(5, 'Suporte Torre 80cm Dourado', 'sp_torre'),
        new item(18, 'Suporte Torre 80cm Preto', 'sp_torre'),
        new item(9, 'Suporte Torre 110cm Dourado', 'sp_torre'),
        new item(8, 'Suporte Torre 110cm Preto', 'sp_torre'),

        new item(2, 'Tripé Decorativo Grande Dourado', 'tp_decorativo'),
        ...
        new item(6, 'Violeteiro Com Corrente - 5 Vasos', 'violeteiro'),
...
var rischioto = new Inventario(
    ...
    [
        ...
        new item(13, 'Cuia Bella Fiore 4 litros Cerâmica', 'cuia_bf_4'),
        new item(15, 'Cuia Bella Fiore 4 litros Preto', 'cuia_bf_4'),

        new item(35, 'Cuia Bella Fiore 7.5 litros Areia', 'cuia_bf_7.5'),
        new item(33, 'Cuia Bella Fiore 7.5 litros Cerâmica', 'cuia_bf_7.5'),
        new item(16, 'Cuia Bella Fiore 7.5 litros Preto', 'cuia_bf_7.5'),
        ...
        new item(22, 'Floreira Floratta n30 Areia', 'floreira_30'),
        ...
        new item(21, 'Floreira Floratta n30 Verde Escuro', 'floreira_30'),
        ...
        new item(60, 'Jardineira Bella Fiore n35 Cerâmica', 'jardineira_n35'),
        ...
        new item(48, 'Jardineira Bella Fiore n50 Preta', 'jardineira_n50'),
        ...
        new item(14, 'Jardineira Floratta n80 Areia', 'jardineira_floratta_80'),
        ...
        new item(6, 'Jardineira Floratta n80 Preta', 'jardineira_floratta_80'),
        ...
        new item(17, 'Jardineira Floratta n80 Verde Escuro', 'jardineira_floratta_80'),
        ...
        new item(11, 'Vaso Coluna Floratta P Areia', 'vaso_coluna_p'),
        new item(27, 'Vaso Coluna Floratta P Preto', 'vaso_coluna_p'),
        new item(4, 'Vaso Coluna Floratta P Rosa', 'vaso_coluna_p'),
        new item(34, 'Vaso Coluna Floratta P Verde Escuro', 'vaso_coluna_p'),

        new item(13, 'Vaso Coluna Floratta M Areia', 'vaso_coluna_m'),
        new item(36, 'Vaso Coluna Floratta M Preto', 'vaso_coluna_m'),
        new item(4, 'Vaso Coluna Floratta M Rosa', 'vaso_coluna_m'),
        new item(25, 'Vaso Coluna Floratta M Verde Escuro', 'vaso_coluna_m'),
        ...
        new item(24, 'Vaso Coluna Floratta G Verde Escuro', 'vaso_coluna_g'),
        ...
        new item(9, 'Vaso de Parede Bella Fiore 1.7 litros Preto', 'vp_florença_1.7'),
        ...
        new item(72, 'Vaso Quadrado Bella Fiore n17 Areia', 'quadrado_n17'),
        new item(58, 'Vaso Quadrado Bella Fiore n17 Cerâmica', 'quadrado_n17'),
        new item(61, 'Vaso Quadrado Bella Fiore n17 Preto', 'quadrado_n17'),

        new item(35, 'Vaso Quadrado Bella Fiore n22 Areia', 'quadrado_n22'),
        new item(36, 'Vaso Quadrado Bella Fiore n22 Cerâmica', 'quadrado_n22'),
        new item(42, 'Vaso Quadrado Bella Fiore n22 Preto', 'quadrado_n22'),

        new item(28, 'Vaso Quadrado Bella Fiore n28 Areia', 'quadrado_n28'),
        new item(24, 'Vaso Quadrado Bella Fiore n28 Cerâmica', 'quadrado_n28'),
        new item(9, 'Vaso Quadrado Bella Fiore n28 Preto', 'quadrado_n28'),

        new item(19, 'Vaso Quadrado Bella Fiore n35 Areia', 'quadrado_n35'),
        new item(14, 'Vaso Quadrado Bella Fiore n35 Cerâmica', 'quadrado_n35'),
        new item(26, 'Vaso Quadrado Bella Fiore n35 Preto', 'quadrado_n35'),

        new item(18, 'Vaso Quadrado Bella Fiore n42 Areia', 'quadrado_n42'),
        new item(22, 'Vaso Quadrado Bella Fiore n42 Cerâmica', 'quadrado_n42'),
        new item(11, 'Vaso Quadrado Bella Fiore n42 Preto', 'quadrado_n42'),
        
        new item(35, 'Vaso Redondo Bella Fiore n13 Areia', 'redondo_n13'),
        new item(44, 'Vaso Redondo Bella Fiore n13 Cerâmica', 'redondo_n13'),
        new item(63, 'Vaso Redondo Bella Fiore n13 Preto', 'redondo_n13'),
        ...
        new item(38, 'Vaso Redondo Bella Fiore n22 Areia', 'redondo_n22'),
        new item(42, 'Vaso Redondo Bella Fiore n22 Ceoâmica', 'redondo_n22'),
        new item(38, 'Vaso Redondo Bella Fiore n22 Preto', 'redondo_n22'),

        new item(41, 'Vaso Redondo Bella Fiore n28 Areia', 'redondo_n28'),
        new item(20, 'Vaso Redondo Bella Fiore n28 Cerâmica', 'redondo_n28'),
        new item(31, 'Vaso Redondo Bella Fiore n28 Preto', 'redondo_n28'),

        new item(33, 'Vaso Redondo Bella Fiore n35 Areia', 'redondo_n35'),
        new item(34, 'Vaso Redondo Bella Fiore n35 Cerâmica', 'redondo_n35'),
        new item(46, 'Vaso Redondo Bella Fiore n35 Preto', 'redondo_n35'),

        new item(30, 'Vaso Redondo Bella Fiore n42 Areia', 'redondo_n42'),
        new item(27, 'Vaso Redondo Bella Fiore n42 Cerâmica', 'redondo_n42'),
        new item(35, 'Vaso Redondo Bella Fiore n42 Preto', 'redondo_n42'),

        new item(5, 'Vaso Redondo Bella Fiore n50 Areia', 'redondo_n50'),
        new item(8, 'Vaso Redondo Bella Fiore n50 Cerâmica', 'redondo_n50'),
        new item(22, 'Vaso Redondo Bella Fiore n50 Preto', 'redondo_n50'),
        ...
        new item(30, 'Vaso Redondo Floratta n26 Rosa', 'redondo_floratta_26'),
        new item(34, 'Vaso Redondo Floratta n26 Verde', 'redondo_floratta_26'),
        new item(28, 'Vaso Redondo Floratta n26 Verde Escuro', 'redondo_floratta_26'),
        ...
        new item(27, 'Vaso Redondo Floratta n33 Preto', 'redondo_floratta_33'),
        ...
        new item(24, 'Vaso Redondo Floratta n33 Verde Escuro', 'redondo_floratta_33'),
        ...
        new item(12, 'Vaso Redondo Floratta n50 Preto', 'redondo_floratta_50'),
        ...
        new item(9, 'Vaso Redondo Floratta n50 Verde Escuro', 'redondo_floratta_50')
    ]
)
var emeAeme = new Inventario(
    ...
    [
        ...
        new item(108, 'Alça Universal Preta', 'alça_universal'),
        new item(16, 'Alça Universal Verde', 'alça_universal'),

        new item(30, 'Cachepot Floreira Luxury Bege', 'floreira_luxyry'),
        new item(30, 'Cachepot Floreira Luxury Branco', 'floreira_luxyry'),
        new item(30, 'Cachepot Floreira Luxury Branco Carrara', 'floreira_luxyry'),
        new item(30, 'Cachepot Floreira Luxury Cafe', 'floreira_luxyry'),
        new item(30, 'Cachepot Floreira Luxury Verde Caribe', 'floreira_luxyry'),
        new item(10, 'Cachepot Floreira Luxury Verde Oliva', 'floreira_luxyry'),

        new item(10, 'Cachepot Luxury 6 Bege', 'luxyry_6'),
        new item(10, 'Cachepot Luxury 6 Branco', 'luxyry_6'),
        new item(10, 'Cachepot Luxury 6 Branco Carrara', 'luxyry_6'),
        new item(10, 'Cachepot Luxury 6 Cafe', 'luxyry_6'),
        new item(10, 'Cachepot Luxury 6 Diamante Negro', 'luxyry_6'),
        new item(10, 'Cachepot Luxury 6 Verde Caribe', 'luxyry_6'),
        new item(10, 'Cachepot Luxury 6 Verde Oliva', 'luxyry_6'),

        new item(20, 'Cachepot Luxury 9 Bege', 'luxyry_9'),
        new item(18, 'Cachepot Luxury 9 Branco', 'luxyry_9'),
        new item(20, 'Cachepot Luxury 9 Branco Carrara', 'luxyry_9'),
        new item(20, 'Cachepot Luxury 9 Cafe', 'luxyry_9'),
        new item(20, 'Cachepot Luxury 9 Diamante Negro', 'luxyry_9'),
        new item(20, 'Cachepot Luxury 9 Verde Caribe', 'luxyry_9'),

        new item(20, 'Cachepot Luxury 11 Bege', 'luxyry_11'),
        new item(13, 'Cachepot Luxury 11 Branco', 'luxyry_11'),
        new item(20, 'Cachepot Luxury 11 Branco Carrara', 'luxyry_11'),
        new item(25, 'Cachepot Luxury 11 Cafe', 'luxyry_11'),
        new item(25, 'Cachepot Luxury 11 Diamante Negro', 'luxyry_11'),
        new item(20, 'Cachepot Luxury 11 Verde Caribe', 'luxyry_11'),

        new item(10, 'Cachepot Luxury 13 Bege', 'luxyry_13'),
        new item(10, 'Cachepot Luxury 13 Branco', 'luxyry_13'),
        new item(10, 'Cachepot Luxury 13 Branco Carrara', 'luxyry_13'),
        new item(10, 'Cachepot Luxury 13 Cafe', 'luxyry_13'),
        new item(10, 'Cachepot Luxury 13 Verde Caribe', 'luxyry_13'),
        new item(10, 'Cachepot Luxury 13 Verde Oliva', 'luxyry_13'),

        new item(28, 'Cachepot Luxury 15 Bege', 'luxyry_15'),
        new item(21, 'Cachepot Luxury 15 Branco', 'luxyry_15'),
        new item(28, 'Cachepot Luxury 15 Branco Carrara', 'luxyry_15'),
        new item(23, 'Cachepot Luxury 15 Cafe', 'luxyry_15'),
        new item(23, 'Cachepot Luxury 15 Diamante Negro', 'luxyry_15'),
        new item(28, 'Cachepot Luxury 15 Verde Caribe', 'luxyry_15'),
        new item(10, 'Cachepot Luxury 15 Verde Oliva', 'luxyry_15'),

        new item(10, 'Cachepot Luxury 16 Bege', 'luxyry_16'),
        new item(10, 'Cachepot Luxury 16 Branco', 'luxyry_16'),
        new item(10, 'Cachepot Luxury 16 Branco Carrara', 'luxyry_16'),
        new item(10, 'Cachepot Luxury 16 Cafe', 'luxyry_16'),
        new item(10, 'Cachepot Luxury 16 Diamante Negro', 'luxyry_16'),
        new item(10, 'Cachepot Luxury 16 Verde Caribe', 'luxyry_16'),
        new item(10, 'Cachepot Luxury 16 Verde Oliva', 'luxyry_16'),

        new item(52, 'Cuia CB 13 Branca', 'cuia_cb_13'),
        new item(50, 'Cuia CB 13 Café', 'cuia_cb_13'),
        ...
        new item(50, 'Cuia CB 15 Café', 'cuia_cb_15'),
        ...
        new item(61, 'Cuia CBB 18 Com Base Café', 'cuia_cbb_18'),
        new item(51, 'Cuia CBB 18 Com Base Cerâmica', 'cuia_cbb_18'),
        new item(54, 'Cuia CBB 18 Com Base Marfim', 'cuia_cbb_18'),
        new item(58, 'Cuia CBB 18 Com Base Preta', 'cuia_cbb_18'),
        new item(59, 'Cuia CBB 18 Com Base Verde', 'cuia_cbb_18'),

        new item(50, 'Cuia CBB 21 Com Base Branca', 'cuia_cbb_21'),
        new item(60, 'Cuia CBB 21 Com Base Café', 'cuia_cbb_21'),
        new item(47, 'Cuia CBB 21 Com Base Cerâmica', 'cuia_cbb_21'),
        new item(63, 'Cuia CBB 21 Com Base Marfim', 'cuia_cbb_21'),
        ...
        new item(53, 'Cuia CBB 25 Com Base Café', 'cuia_cbb_25'),
        new item(44, 'Cuia CBB 25 Com Base Cerâmica', 'cuia_cbb_25'),
        new item(64, 'Cuia CBB 25 Com Base Marfim', 'cuia_cbb_25'),
        new item(59, 'Cuia CBB 25 Com Base Preta', 'cuia_cbb_25'),
        new item(55, 'Cuia CBB 25 Com Base Verde', 'cuia_cbb_25'),
        ...
        new item(51, 'Cuia CBB 30 Com Base Marfim', 'cuia_cbb_30'),
        new item(63, 'Cuia CBB 30 Com Base Preta', 'cuia_cbb_30'),
        new item(55, 'Cuia CBB 30 Com Base Verde', 'cuia_cbb_30'),

        new item(36, 'Cuia Gran Imperial CBB 40 Com Base Cerâmica', 'cuia_cbb_40'),
        new item(48, 'Cuia Gran Imperial CBB 40 Com Base Preta', 'cuia_cbb_40'),
        ...
        new item(30, 'Floreira FCB 30 Com Base Cimento', 'floreira_fcb_30'),
        new item(39, 'Floreira FCB 30 Com Base Preta', 'floreira_fcb_30'),
        new item(30, 'Floreira FCB 30 Com Base Verde', 'floreira_fcb_30'),
        new item(20, 'Floreira FCB 30 Com Base Verde Antigo', 'floreira_fcb_30'),
        ...
        new item(39, 'Floreira FCB 40 Com Base Preta', 'floreira_fcb_40'),
        new item(37, 'Floreira FCB 40 Com Base Verde', 'floreira_fcb_40'),
        new item(20, 'Floreira FCB 40 Com Base Verde Antigo', 'floreira_fcb_40'),

        new item(39, 'Floreira FCB 60 Com Base Café', 'floreira_fcb_60'),
        new item(33, 'Floreira FCB 60 Com Base Cerâmica', 'floreira_fcb_60'),
        new item(44, 'Floreira FCB 60 Com Base Cimento', 'floreira_fcb_60'),
        new item(41, 'Floreira FCB 60 Com Base Preta', 'floreira_fcb_60'),
        new item(33, 'Floreira FCB 60 Com Base Verde', 'floreira_fcb_60'),
        new item(20, 'Floreira FCB 60 Com Base Verde Antigo', 'floreira_fcb_60'),

        new item(99, 'Prato B006 6cm Cerâmica', 'prato_b006'),
        new item(101, 'Prato B006 6cm Preto', 'prato_b006'),

        new item(107, 'Prato B00 9.5cm Cerâmica', 'prato_b00'),
        new item(95, 'Prato B00 9.5cm Cimento', 'prato_b00'),
        new item(95, 'Prato B00 9.5cm Marfim', 'prato_b00'),
        new item(95, 'Prato B00 9.5cm Preto', 'prato_b00'),

        new item(246, 'Prato B01 11.5cm Cerâmica', 'prato_b01'),
        new item(103, 'Prato B01 11.5cm Cimento', 'prato_b01'),
        new item(99, 'Prato B01 11.5cm Marfim', 'prato_b01'),
        new item(250, 'Prato B01 11.5cm Preto', 'prato_b01'),

        new item(250, 'Prato B02 13cm Cerâmica', 'prato_b02'),
        new item(99, 'Prato B02 13cm Cimento', 'prato_b02'),
        new item(93, 'Prato B02 13cm Marfim', 'prato_b02'),
        new item(250, 'Prato B02 13cm Preto', 'prato_b02'),
        ...
        new item(250, 'Prato B03 16cm Preto', 'prato_b03'),

        new item(205, 'Prato B04 21cm Cerâmica', 'prato_b04'),
        new item(56, 'Prato B04 21cm Cimento', 'prato_b04'),
        new item(55, 'Prato B04 21cm Marfim', 'prato_b04'),
        new item(193, 'Prato B04 21cm Preto', 'prato_b04'),
        new item(30, 'Prato B04 21cm Verde', 'prato_b04'),
        ...
        new item(30, 'Prato B04.5 22cm Verde', 'prato_b4.5'),

        new item(90, 'Prato B05 24cm Cerâmica', 'prato_b05'),
        new item(56, 'Prato B05 24cm Cimento', 'prato_b05'),
        new item(54, 'Prato B05 24cm Marfim', 'prato_b05'),
        new item(92, 'Prato B05 24cm Preto', 'prato_b05'),
        new item(30, 'Prato B05 24cm Verde', 'prato_b05'),
        ...
        new item(30, 'Prato B06 27cm Verde', 'prato_b06'),
        ...
        new item(91, 'Prato B08 33cm Preto', 'prato_b08'),

        new item(72, 'Prato B09 38cm Cerâmica', 'prato_b09'),
        ...
        new item(45, 'Prato B10 42cm Cerâmica', 'prato_b10'),
        ...
        new item(30, 'Vaso De Parede VP 14 Verde Antigo', 'vp_14'),

        new item(50, 'Vaso De Parede VP 20 Branco', 'vp_20'),
        new item(63, 'Vaso De Parede VP 20 Cerâmica', 'vp_20'),
        new item(68, 'Vaso De Parede VP 20 Preto', 'vp_20'),
        new item(56, 'Vaso De Parede VP 20 Verde', 'vp_20'),
        new item(30, 'Vaso De Parede VP 20 Verde Antigo', 'vp_20'),

        new item(51, 'Vaso De Parede VP 30 Branco', 'vp_30'),
        new item(57, 'Vaso De Parede VP 30 Cerâmica', 'vp_30'),
        new item(46, 'Vaso De Parede VP 30 Preto', 'vp_30'),
        ...
        new item(25, 'Vaso Imperial V30 Cimento', 'v_imperial_30'),
        new item(27, 'Vaso Imperial V30 Marfim', 'v_imperial_30'),
        new item(33, 'Vaso Imperial V30 Preto', 'v_imperial_30'),

        new item(15, 'Vaso Imperial V40 Cerâmica', 'v_imperial_40'),
        new item(15, 'Vaso Imperial V40 Cimento', 'v_imperial_40'),
        new item(15, 'Vaso Imperial V40 Marfim', 'v_imperial_40'),
        new item(18, 'Vaso Imperial V40 Preto', 'v_imperial_40'),

        new item(55, 'Vaso T 07 Cerâmica', 'vaso_t_07'),
        new item(96, 'Vaso T 07 Preto', 'vaso_t_07'),

        new item(97, 'Vaso T 09 Cerâmica', 'vaso_t_09'),
        new item(74, 'Vaso T 09 Preto', 'vaso_t_09'),

        new item(70, 'Vaso T 10 Cerâmica', 'vaso_t_10'),
        new item(89, 'Vaso T 10 Preto', 'vaso_t_10'),

        new item(65, 'Vaso T 12 Cerâmica', 'vaso_t_12'),
        new item(88, 'Vaso T 12 Preto', 'vaso_t_12'),

        new item(95, 'Vaso T 14 Cerâmica', 'vaso_t_14'),
        new item(100, 'Vaso T 14 Preto', 'vaso_t_14'),

        new item(60, 'Vaso T 16 Cerâmica', 'vaso_t_16'),
        new item(76, 'Vaso T 16 Preto', 'vaso_t_16'),

        new item(43, 'Vaso T 18 Cerâmica', 'vaso_t_18'),
        new item(62, 'Vaso T 18 Preto', 'vaso_t_18'),
        ...
        new item(30, 'Vaso T 30 Preto', 'vaso_t_30'),

        new item(49, 'Vaso T 35 Cerâmica', 'vaso_t_35'),
        new item(38, 'Vaso T 35 Preto', 'vaso_t_35')
    ]
)
var forth = new Inventario(
    ...
    '07/02/2024',
    [
        new item(6, 'Acaricida Concentrado - 60ml', 'a'),
        ...
        new item(11, 'Brilha folha p/uso - 500ml', 'b'),

        new item(9, 'Cactos Concentrado - 60ml', 'c'),
        new item(11, 'Cactos Concentrado - 500m', 'c'),
        new item(25, 'Cobre Concentrado - 60ml', 'c'),
        new item(12, 'Cobre Concentrado - 500m', 'c'),
        new item(27, 'Coqueiros - 400g', 'c'),
        new item(21, 'Coqueiros - 3kg', 'c'),
        new item(1, 'Coqueiros - 10Kg', 'c'),
        new item(2, 'Cote 14.14.14 - 150g', 'c'),
        new item(1, 'Cote 15.09.12 - 150g', 'c'),
        new item(8, 'Cote 14.14.14 - 400g', 'c'),
        new item(2, 'Cote 15.09.12 - 400g', 'c'),
        new item(4, 'Cupinicida Concentrado - 60ml', 'c'),

        new item(0, 'Defende Concentrado - 30ml', 'd'),
        new item(7, 'Defende p/uso - 500ml', 'd'),

        new item(10, 'Enraizador Concentrado - 60ml', 'e'),
        new item(35, 'Enxofre Concentrado - 60ml', 'e'),
        new item(13, 'Enxofre p/uso - 500ml', 'e'),
        new item(13, 'Equilibrio Concentrado - 60ml', 'e'),
        new item(6, 'Equilibrio Concentrado - 500ml', 'e'),

        new item(12, 'Fipronil+imidacloprid Concentrado - 60ml', 'f'),
        new item(10, 'Flores Concentrado - 60ml', 'f'),
        new item(14, 'Flores p/uso - 500ml', 'f'),
        new item(68, 'Flores - 400g', 'f'),
        new item(27, 'Flores - 3kg', 'f'),
        new item(0, 'Flores - 10Kg', 'f'),
        new item(31, 'Formicida Gel', 'f'),
        new item(8, 'Formicida isca granulada', 'f'), 
        new item(8, 'Formicida Mata no ninho p/uso - 500ml', 'f'),
        new item(0, 'Fosfito - 60ml', 'f'),
        new item(7, 'Fosfito p/uso - 500ml', 'f'),
        new item(0, 'Frutas Concentrado - 60ml', 'f'),
        new item(17, 'Frutas p/uso - 500ml', 'f'),
        new item(57, 'Frutas - 400g', 'f'),
        new item(27, 'Frutas - 3kg', 'f'),
        new item(0, 'Frutas - 10Kg', 'f'),
        new item(11, 'Fungicida Concentrado - 30ml', 'f'),
        new item(18, 'Fungicida p/uso - 500ml', 'f'),
        new item(10, 'Fungicida cobre p/uso - 500ml', 'f'),

        new item(0, 'Gel para plantio - 100g', 'g'),

        new item(8, 'Hortaliças Concentrado - 60ml', 'h'),
        new item(13, 'Hortaliças p/uso - 500ml', 'h'),
        new item(37, 'Hortaliças - 400g', 'h'),
        new item(12, 'Hortaliças - 3kg', 'h'),
        new item(0, 'Hortaliças - 10Kg', 'h'),

        new item(26, 'Inseticida Concentrado - 30ml', 'i'),
        new item(23, 'Inseticida p/uso - 500ml', 'i'),

        new item(9, 'Jabuticabeiras Concentrado - 60ml', 'j'),
        new item(21, 'Jabuticabeiras - 400g', 'j'),
        new item(11, 'Jabuticabeiras - 3kg', 'j'),
        new item(3, 'Jardim Concentrado - 60ml', 'j'),
        new item(12, 'Jardim Concentrado - 500ml', 'j'),
        new item(14, 'Jardim p/uso - 500ml', 'j'),
        new item(30, 'Jardim - 400g', 'j'),
        new item(16, 'Jardim - 3kg', 'j'),

        new item(4, 'Lesmicida isca granulada', 'l'),

        new item(31, 'Mata cochonilha p/uso - 500ml', 'm'),
        new item(20, 'Mata lagarta p/uso - 500ml', 'm'),
        new item(0, 'Mata mato Concentrado - 30ml', 'm'),
        new item(5, 'Mata mato p/uso - 500ml', 'm'),
        new item(28, 'Mata pulgão p/uso - 500ml', 'm'),

        new item(27, 'Óleo Concentrado - 60ml', 'o'),
        new item(20, 'Orquídeas Floração Concentrado - 60ml', 'o'),
        new item(16, 'Orquídeas Floração p/uso - 500ml', 'o'),
        new item(41, 'Orquídeas Manutenção Concentrado - 60ml', 'o'),
        new item(18, 'Orquídeas Manutenção p/uso - 500ml', 'o'),
        new item(18, 'Orquídeas 09.45.15 - 100g', 'o'),
        new item(28, 'Orquídeas 20.20.20 - 100g', 'o'),
        new item(22, 'Orquídeas 30.10.10 - 100g', 'o'),
        new item(4, 'Orquídeas 09.45.15 - 400g', 'o'),
        ...
        new item(20, 'Palmeiras - 400g', 'p'),
        new item(12, 'Palmeiras - 3kg', 'p'),
        new item(17, 'Pasta selante', 'p'),
        new item(12, 'Plantio - 400g', 'p'),
        ...
        new item(40, 'Rosa do Deserto - 400g', 'r'),
        new item(2, 'Rosa do Deserto - 3kg', 'r'),

        new item(11, 'Samambaias Concentrado - 60ml', 's'),
...
var alfa_polietileno = new Inventario(
    ...
    [
        ...
        new item(8, 'Bacia Diamante nº 2 Bege', 'bacia_diamante_2'),
        new item(11, 'Bacia Diamante nº 2 Cimento', 'bacia_diamante_2'),
        new item(10, 'Bacia Diamante nº 2 Marrom', 'bacia_diamante_2'),
        new item(11, 'Bacia Diamante nº 2 Preto', 'bacia_diamante_2'),
        ...
        new item(5, 'Bacia Grafiato C/ Prato nº 1 Bege', 'bacia_grafiato_1'),
        new item(2, 'Bacia Grafiato C/ Prato nº 1 Cimento', 'bacia_grafiato_1'),
        new item(1, 'Bacia Grafiato C/ Prato nº 1 Marrom', 'bacia_grafiato_1'),
        new item(8, 'Bacia Grafiato C/ Prato nº 1 Preto', 'bacia_grafiato_1'),

        new item(8, 'Bacia Grafiato C/Prato nº 2 Bege', 'bacia_grafiato_2'),
        new item(6, 'Bacia Grafiato C/Prato nº 2 Cimento', 'bacia_grafiato_2'),
        new item(6, 'Bacia Grafiato C/Prato nº 2 Marrom', 'bacia_grafiato_2'),
        new item(9, 'Bacia Grafiato C/Prato nº 2 Preto', 'bacia_grafiato_2'),

        new item(11, 'Bacia Grafiato C/Prato nº 3 Bege', 'bacia_grafiato_3'),
        new item(11, 'Bacia Grafiato C/Prato nº 3 Cimento', 'bacia_grafiato_3'),
        new item(9, 'Bacia Grafiato C/Prato nº 3 Marrom', 'bacia_grafiato_3'),
        new item(11, 'Bacia Grafiato C/Prato nº 3 Preto', 'bacia_grafiato_3'),

        new item(10, 'Bacia Grafiato C/Prato nº 4 Bege', 'bacia_grafiato_4'),
        new item(10, 'Bacia Grafiato C/Prato nº 4 Cimento', 'bacia_grafiato_4'),
        new item(7, 'Bacia Grafiato C/Prato nº 4 Marrom', 'bacia_grafiato_4'),
        ...
        new item(5, 'Bacia Marmorizada C/Prato nº 2 Azul', 'bacia_marmorizada_2'),
        ...
        new item(5, 'Bacia Polida C/Prato nº 1 Cimento', 'bacia_polida_1'),
        new item(8, 'Bacia Polida C/Prato nº 1 Marrom', 'bacia_polida_1'),
        ...
        new item(1, 'Coluna Red. Degrau Grafiato C/Prato nº 4 Bege', 'coluna_degrau_4'),
        new item(4, 'Coluna Red. Degrau Grafiato C/Prato nº 4 Cimento', 'coluna_degrau_4'),
        new item(5, 'Coluna Red. Degrau Grafiato C/Prato nº 4 Marrom', 'coluna_degrau_4'),
        new item(5, 'Coluna Red. Degrau Grafiato C/Prato nº 4 Preto', 'coluna_degrau_4'),

        new item(5, 'Coluna Red. Degrau Grafiato C/Prato nº 5 Bege', 'coluna_degrau_5'),
        new item(6, 'Coluna Red. Degrau Grafiato C/Prato nº 5 Cimento', 'coluna_degrau_5'),
        new item(6, 'Coluna Red. Degrau Grafiato C/Prato nº 5 Marrom', 'coluna_degrau_5'),
        new item(6, 'Coluna Red. Degrau Grafiato C/Prato nº 5 Preto', 'coluna_degrau_5'),

        new item(9, 'Coluna Red. Diamante C/Prato nº 1 Bege', 'coluna_diamante_1'),
        new item(7, 'Coluna Red. Diamante C/Prato nº 1 Cimento', 'coluna_diamante_1'),
        new item(7, 'Coluna Red. Diamante C/Prato nº 1 Marrom', 'coluna_diamante_1'),
        new item(8, 'Coluna Red. Diamante C/Prato nº 1 Preta', 'coluna_diamante_1'),

        new item(10, 'Coluna Red. Diamante C/Prato nº 2 Bege', 'coluna_diamante_2'),
        new item(8, 'Coluna Red. Diamante C/Prato nº 2 Cimento', 'coluna_diamante_2'),
        new item(8, 'Coluna Red. Diamante C/Prato nº 2 Marrom', 'coluna_diamante_2'),
        new item(8, 'Coluna Red. Diamante C/Prato nº 2 Preta', 'coluna_diamante_2'),

        new item(10, 'Coluna Red. Diamante C/Prato nº 3 Bege', 'coluna_diamante_3'),
        new item(9, 'Coluna Red. Diamante C/Prato nº 3 Cimento', 'coluna_diamante_3'),
        new item(7, 'Coluna Red. Diamante C/Prato nº 3 Marrom', 'coluna_diamante_3'),
        new item(9, 'Coluna Red. Diamante C/Prato nº 3 Preta', 'coluna_diamante_3'),

        new item(4, 'Coluna Red. Diamante C/Prato nº 4 Bege', 'coluna_diamante_4'),
        new item(4, 'Coluna Red. Diamante C/Prato nº 4 Cimento', 'coluna_diamante_4'),
        new item(4, 'Coluna Red. Diamante C/Prato nº 4 Marrom', 'coluna_diamante_4'),
        ...
        new item(6, 'Coluna Red. Diamante C/Prato nº 5 Cimento', 'coluna_diamante_5'),
        ...
        new item(2, 'Coluna Red. Grafiato C/Prato nº 4 Bege', 'coluna_grafiato_4'),
        new item(3, 'Coluna Red. Grafiato C/Prato nº 4 Cimento', 'coluna_grafiato_4'),
        new item(0, 'Coluna Red. Grafiato C/Prato nº 4 Marrom', 'coluna_grafiato_4'),
        new item(5, 'Coluna Red. Grafiato C/Prato nº 4 Preto', 'coluna_grafiato_4'),

        new item(1, 'Coluna Red. Marmorizada C/Prato nº 1 Azul', 'coluna_marmorizada_1'),
        new item(5, 'Coluna Red. Marmorizada C/Prato nº 1 Vermelho', 'coluna_marmorizada_1'),

        new item(0, 'Coluna Red. Marmorizada C/Prato nº 2 Azul', 'coluna_marmorizada_2'),
        new item(5, 'Coluna Red. Marmorizada C/Prato nº 2 verde', 'coluna_marmorizada_2'),
        new item(3, 'Coluna Red. Marmorizada C/Prato nº 2 Vermelho', 'coluna_marmorizada_2'),

        new item(6, 'Coluna Red. Marmorizada C/Prato nº 3 Azul', 'coluna_marmorizada_3'),
        ...
        new item(4, 'Coluna Red. Polida C/Prato nº 1 Cimento', 'coluna_polida_1'),
        ...
        new item(7, 'Coluna Red. Polida C/Prato nº 3 Bege', 'coluna_polida_3'),
        ...
        new item(5, 'Coluna Red. Polida C/Prato nº 4 Bege', 'coluna_polida_4'),
        new item(7, 'Coluna Red. Polida C/Prato nº 4 Cimento', 'coluna_polida_4'),
        new item(8, 'Coluna Red. Polida C/Prato nº 4 Marrom', 'coluna_polida_4'),
        new item(9, 'Coluna Red. Polida C/Prato nº 4 Preto', 'coluna_polida_4'),
        ...
        new item(1, 'Jardineira Grafiato C/Prato nº 1 Bege', 'jardineira_grafiato_1'),
        new item(4, 'Jardineira Grafiato C/Prato nº 1 Cimento', 'jardineira_grafiato_1'),
        new item(1, 'Jardineira Grafiato C/Prato nº 1 Marrom', 'jardineira_grafiato_1'),
        new item(5, 'Jardineira Grafiato C/Prato nº 1 Preto', 'jardineira_grafiato_1'),

        new item(3, 'Jardineira Grafiato C/Prato nº 2 Bege', 'jardineira_grafiato_2'),
        new item(3, 'Jardineira Grafiato C/Prato nº 2 Marrom', 'jardineira_grafiato_2'),
        ...
        new item(5, 'Vaso Bojo Red. Diamante C/Prato nº 1 Cimento', 'vaso_diamante_1'),
        new item(2, 'Vaso Bojo Red. Diamante C/Prato nº 1 Marrom', 'vaso_diamante_1'),
        ...
        new item(6, 'Vaso Bojo Red. Diamante C/Prato nº 3 Preto', 'vaso_diamante_3'),
        ...
        new item(5, 'Vaso Bojo Frisado C/Prato nº 1 Marrom', 'vaso_frisado_1'),
        ...
        new item(9, 'Vaso Bojo Frisado C/Prato nº 2 Cimento', 'vaso_frisado_2'),
        new item(2, 'Vaso Bojo Frisado C/Prato nº 2 Marrom', 'vaso_frisado_2'),
        ...
        new item(8, 'Vaso Bojo Frisado C/Prato nº 4 Bege', 'vaso_frisado_4'),
        new item(8, 'Vaso Bojo Frisado C/Prato nº 4 Cimento', 'vaso_frisado_4'),
        new item(2, 'Vaso Bojo Frisado C/Prato nº 4 Marrom', 'vaso_frisado_4'),
        ...
        new item(5, 'Vaso Bojo Red. Grafiato C/Prato nº 1 Cimento', 'vaso_grafiato_1'),
        ...
        new item(1, 'Vaso Bojo Red. Grafiato C/Prato nº 2 Bege', 'vaso_grafiato_2'),
        new item(6, 'Vaso Bojo Red. Grafiato C/Prato nº 2 Cimento', 'vaso_grafiato_2'),
        new item(5, 'Vaso Bojo Red. Grafiato C/Prato nº 2 Marrom', 'vaso_grafiato_2'),
        new item(10, 'Vaso Bojo Red. Grafiato C/Prato nº 2 Preto', 'vaso_grafiato_2'),

        new item(5, 'Vaso Bojo Red. Grafiato C/Prato nº 3 Bege', 'vaso_grafiato_3'),
        ...
        new item(6, 'Vaso Bojo Red. Grafiato C/Prato nº 4 Bege', 'vaso_grafiato_4'),
        new item(7, 'Vaso Bojo Red. Grafiato C/Prato nº 4 Cimento', 'vaso_grafiato_4'),
        new item(6, 'Vaso Bojo Red. Grafiato C/Prato nº 4 Marrom', 'vaso_grafiato_4'),
        new item(7, 'Vaso Bojo Red. Grafiato C/Prato nº 4 Preto', 'vaso_grafiato_4'),

        new item(8, 'Vaso Bojo Red. Lisboa C/Prato nº 1 Bege', 'vaso_grafiato_4'),
        new item(8, 'Vaso Bojo Red. Lisboa C/Prato nº 1 Cimento', 'vaso_grafiato_4'),
        new item(8, 'Vaso Bojo Red. Lisboa C/Prato nº 1 Marrom', 'vaso_grafiato_4'),
        new item(8, 'Vaso Bojo Red. Lisboa C/Prato nº 1 Preto', 'vaso_grafiato_4'),

        new item(7, 'Vaso Bojo Red. Lisboa C/Prato nº 2 Bege', 'vaso_grafiato_4'),
        new item(8, 'Vaso Bojo Red. Lisboa C/Prato nº 2 Cimento', 'vaso_grafiato_4'),
        new item(7, 'Vaso Bojo Red. Lisboa C/Prato nº 2 Marrom', 'vaso_grafiato_4'),
        ...
        new item(8, 'Vaso Bojo Red. Marmorizado C/Prato nº 2 Azul', 'vaso_marmorizado_2'),
        ...
        new item(1, 'Vaso Bojo Red. Polido C/Prato nº 1 Bege', 'vaso_polido_1'),
        ...
        new item(2, 'Vaso Bojo Red. Polido C/Prato nº 1 Preto', 'vaso_polido_1'),
        ...
        new item(7, 'Vaso Bojo Red. Polido C/Prato nº 3 Cimento', 'vaso_polido_3'),
        new item(10, 'Vaso Bojo Red. Polido C/Prato nº 3 Marrom', 'vaso_polido_3'),
...
var alfa_fibraSintetica = new Inventario(
    ...
    '--/--/----',
    [
        new item(10, "Cuia Sem Borda nº 0 Argila", 'cuia_1'),
        new item(10, "Cuia Sem Borda nº 0 Branco", 'cuia_1'),
        new item(10, "Cuia Sem Borda nº 0 Envelhecido", 'cuia_1'),
        new item(10, "Cuia Sem Borda nº 0 Palha", 'cuia_1'),

        new item(23, "Cuia Sem Borda nº 1 Argila", 'cuia_1'),
        new item(6, "Cuia Sem Borda nº 1 Branco", 'cuia_1'),
        new item(20, "Cuia Sem Borda nº 1 Cappuccino", 'cuia_1'),
        new item(18, "Cuia Sem Borda nº 1 Envelhecido", 'cuia_1'),
        new item(8, "Cuia Sem Borda nº 1 Palha", 'cuia_1'),

        new item(15, "Cuia Sem Borda nº 2 Argila", 'cuia_2'),
        new item(5, "Cuia Sem Borda nº 2 Branco", 'cuia_2'),
        new item(10, "Cuia Sem Borda nº 2 Cafe", 'cuia_2'),
        new item(15, "Cuia Sem Borda nº 2 Cappuccino", 'cuia_2'),
        new item(18, "Cuia Sem Borda nº 2 Envelhecido", 'cuia_2'),
        new item(8, "Cuia Sem Borda nº 2 Palha", 'cuia_2'),

        new item(21, "Cuia Sem Borda nº 3 Argila", 'cuia_3'),
        new item(5, "Cuia Sem Borda nº 3 Branco", 'cuia_3'),
        new item(17, "Cuia Sem Borda nº 3 Cappuccino", 'cuia_3'),
        new item(20, "Cuia Sem Borda nº 3 Envelhecido", 'cuia_3'),
        new item(13, "Cuia Sem Borda nº 3 Palha", 'cuia_3'),

        new item(16, "Cuia Sem Borda nº 4 Argila", 'cuia_4'),
        new item(5, "Cuia Sem Borda nº 4 Branco", 'cuia_4'),
        new item(20, "Cuia Sem Borda nº 4 Cappuccino", 'cuia_4'),
        new item(20, "Cuia Sem Borda nº 4 Envelhecido", 'cuia_4'),
        new item(9, "Cuia Sem Borda nº 4 Palha", 'cuia_4'),

        new item(15, "Cachepot Cactos nº 1 Argila", 'cactus_1'),
        new item(5, "Cachepot Cactos nº 1 Braco", 'cactus_1'),
        new item(15, "Cachepot Cactos nº 1 Cappuccino", 'cactus_1'),
        new item(18, "Cachepot Cactos nº 1 Envelhecido", 'cactus_1'),
        new item(5, "Cachepot Cactos nº 1 Palha", 'cactus_1'),

        new item(18, "Cachepot Cactos nº 2 Argila", 'cactus_2'),
        new item(5, "Cachepot Cactos nº 2 Braco", 'cactus_2'),
        new item(15, "Cachepot Cactos nº 2 Cappuccino", 'cactus_2'),
        new item(9, "Cachepot Cactos nº 2 Envelhecido", 'cactus_2'),
        new item(5, "Cachepot Cactos nº 2 Palha", 'cactus_5'),

        new item(20, "Cachepot Cactos nº 3 Argila", 'cactus_3'),
        new item(5, "Cachepot Cactos nº 3 Braco", 'cactus_3'),
        new item(15, "Cachepot Cactos nº 3 Cappuccino", 'cactus_3'),
        new item(18, "Cachepot Cactos nº 3 Envelhecido", 'cactus_3'),
        new item(5, "Cachepot Cactos nº 3 Palha", 'cactus_3'),

        new item(19 , "Cachepot Sem Borda nº 1 Argile", 'cachepot_1'),
        new item(17, "Cachepot Sem Borda nº 1 Cappuccino", 'cachepot_1'),
        new item(14,  "Cachepot Sem Borda nº 1 Envelhecido", 'cachepot_1'),
        new item(5, "Cachepot Sem Borda nº 1 Palha", 'cachepot_1'),

        new item(20, "Cachepot Sem Borda nº 2 Argile", 'cachepot_2'),
        new item(18, "Cachepot Sem Borda nº 2 Cappuccino", 'cachepot_2'),
        new item(17, "Cachepot Sem Borda nº 2 Envelhecido", 'cachepot_2'),
        new item(3, "Cachepot Sem Borda nº 2 Palha", 'cachepot_2'),

        new item(22, "Cachepot Sem Borda nº 3 Argile", 'cachepot_3'),
        new item(18, "Cachepot Sem Borda nº 3 Cappuccino", 'cachepot_3'),
        new item(16, "Cachepot Sem Borda nº 3 Envelhecido", 'cachepot_3'),
        new item(13, "Cachepot Sem Borda nº 3 Palha", 'cachepot_3'),

        new item(19, "Cachepot Sem Borda nº 4 Argile", 'cachepot_4'),
        new item(19, "Cachepot Sem Borda nº 4 Cappuccino", 'cachepot_4'),
        new item(20, "Cachepot Sem Borda nº 4 Envelhecido", 'cachepot_4'),
        new item(8, "Cachepot Sem Borda nº 4 Palha", 'cachepot_4'),
        ...
        new item(9, "Vaso Red. Sem Borda nº 1 Cappuccino", 'vaso_1'),
        new item(9, "Vaso Red. Sem Borda nº 1 Envelhecido", 'vaso_1'),

        new item(9, "Vaso Red. Sem Borda nº 2 Cappuccino", 'vaso_2'),
        new item(6, "Vaso Red. Sem Borda nº 2 Envelhecido", 'vaso_2'),

        new item(9, "Vaso Red. Sem Borda nº 3 Cappuccino", 'vaso_3'),
        new item(9, "Vaso Red. Sem Borda nº 3 Envelhecido", 'vaso_3'),

        new item(9, "Vaso Red. Sem Borda nº 4 Cappuccino", 'vaso_4'),
        new item(9, "Vaso Red. Sem Borda nº 4 Envelhecido", 'vaso_4')
    ]
)
var policamp = new Inventario(
    ...
    '20/01/2024',
    [
        new item(70, 'Pulverizador 500ml', 'pulverizador'),
        new item(62, 'Pulverizador 1 litro', 'pulverizador'),
        new item(27, 'Regador Com Cabo - Bico', 'Regador_cabo'),
        new item(23, 'Regador Com Cabo - Chuveiro', 'Regador_cabo'),
        new item(106, 'Regador - 2 litros', 'Regador'),
        new item(116, 'Regador - 4 litros', 'Regador'),
        new item(93, 'Regador - 5 litros', 'Regador'),
        new item(58, 'Regador - 10 litros', 'Regador')
    ]
)
var jel_plast = new Inventario(
    ...
    '22/01/2024',
    [
        new item(167, 'Bebedouro Beija Flor Bandeija REF20', 'bebedouro'),
        new item(180, 'Bebedouro Beija Flor Luxo Chapeu Com Poleiro REF50', 'bebedouro'),
        new item(207, 'Bebedouro Beija Flor Puleiro REF55', 'bebedouro'),
...
var madeiras = new Inventario(
    ...
    [
        ...
        new item(13, 'Rodízio Redondo 20cm', 'rodízio_redondo'),
        ...
        new item(2, 'Rodízio Redondo 50cm', 'rodízio_redondo'),
        ...
        new item(9, 'Rodízio Quadrado 40cm', 'rodízio_quadrado'),
        new item(4, 'Rodízio Quadrado 45cm', 'rodízio_quadrado'),
...
var coquim = new Inventario(
    ...
    [
        ...
        new item(5, '1001 - Vaso Coquim nº 5', 'vaso_coquim'),
        ...
        new item(29, '3001 - Estaca Coquim 60cm', 'estaca_coquim'),
        new item(24, '3002 - Estaca Coquim 80cm', 'estaca_coquim'),

        new item(14, '3004 - Estaca Bastão 60cm', 'estaca_bastao'),
        new item(14, '3005 - Estaca Bastão 80cm', 'estaca_bastao'),

        new item(21, '4000 - Mix Coquim 1kg', 'adubos'),
        new item(31, '4001 - Pó de Coco 1kg', 'adubos'),
        ...
        new item(20, '4012 - Fibra Curta 250g', 'adubos'),
