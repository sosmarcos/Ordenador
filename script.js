...
var forth = new Inventario(
    ...
    [
        ...
        new item(18, 'Defende Concentrado - 30ml', 'd'),
        new item(9, 'Defende p/uso - 500ml', 'd'),

        new item(3, 'Enraizador Concentrado - 60ml', 'e'),
        ...
        new item(16, 'Fipronil+imidacloprid Concentrado - 60ml', 'f'),
        new item(5, 'Flores Concentrado - 60ml', 'f'),
        ...
        new item(4, 'Frutas Concentrado - 60ml', 'f'),
        new item(17, 'Frutas p/uso - 500ml', 'f'),
        new item(24, 'Frutas - 400g', 'f'),
        new item(18, 'Frutas - 3kg', 'f'),
        new item(0, 'Frutas - 10Kg', 'f'),
        new item(7, 'Fungicida Concentrado - 30ml', 'f'),
        new item(21, 'Fungicida p/uso - 500ml', 'f'),
        new item(12, 'Fungicida cobre p/uso - 500ml', 'f'),

        new item(10, 'Gel para plantio - 100g', 'g'),

        new item(14, 'Hortaliças Concentrado - 60ml', 'h'),
        new item(13, 'Hortaliças p/uso - 500ml', 'h'),
        new item(41, 'Hortaliças - 400g', 'h'),
        new item(12, 'Hortaliças - 3kg', 'h'),
        new item(0, 'Hortaliças - 10Kg', 'h'),

        new item(13, 'Inseticida Concentrado - 30ml', 'i'),
        new item(4, 'Inseticida p/uso - 500ml', 'i'),

        new item(0, 'Jabuticabeiras Concentrado - 60ml', 'j'),
        new item(0, 'Jabuticabeiras - 400g', 'j'),
        new item(11, 'Jabuticabeiras - 3kg', 'j'),
        new item(4, 'Jardim Concentrado - 60ml', 'j'),
